window.Dom7 = function() {
            ...
            if (e)
                if ("string" == typeof e) {
                    ...
                    if (s.indexOf("<") >= 0 && s.indexOf(">") >= 0) {
                        var o = "div";
                        for (0 === s.indexOf("<li") && (o = "ul"), 0 === s.indexOf("<tr") && (o = "tbody"), 0 !== s.indexOf("<td") && 0 !== s.indexOf("<th") || (o = "tr"), 0 === s.indexOf("<tbody") && (o = "table"), 0 === s.indexOf("<option") && (o = "select"), (i = document.createElement(o)).innerHTML = s, r = 0; r < i.childNodes.length; r += 1) t.push(i.childNodes[r])
                    } else
        ...
        function n(e, a) {
            ...
            return Object.keys(e).forEach(function(o) {
                ...
                if (Array.isArray(e[o])) {
                    l = [];
                    for (var p = 0; p < e[o].length; p += 1) Array.isArray(e[o][p]) || "object" != typeof e[o][p] ? l.push(t(o) + "[]=" + r(e[o][p])) : (i = a.slice(), i.push(o), i.push(String(p)), l.push(n(e[o][p], i)));
                    l.length > 0 && s.push(l.join("&"))
                } else null === e[o] || "" === e[o] ? s.push(t(o) + "=") : "object" == typeof e[o] ? (i = a.slice(), i.push(o), "" !== (l = n(e[o], i)) && s.push(l)) : void 0 !== e[o] && "" !== e[o] ? s.push(t(o) + "=" + r(e[o])) : "" === e[o] && s.push(t(o))
            }), s.join("&")
        }
        ...
        function p(a) {
            ...
            var l, p = a.url.indexOf("?") >= 0 ? "&" : "?",
                d = a.method.toUpperCase();
            "GET" !== d && "HEAD" !== d && "OPTIONS" !== d && "DELETE" !== d || !a.data || (l = "string" == typeof a.data ? a.data.indexOf("?") >= 0 ? a.data.split("?")[1] : a.data : n(a.data)).length && (a.url += p + l, "?" === p && (p = "&"));
            if ("json" === a.dataType && a.url.indexOf("callback=") >= 0) {
                var c, m = "f7jsonp_" + (Date.now() + (k += 1)),
                ...
                return g.type = "text/javascript", g.onerror = function() {
                    clearTimeout(c), r(void 0, void 0, "error", null, "scripterror"), r("ajaxComplete ajax:complete", {
                        scripterror: !0
                    }, "complete", null, "scripterror")
                }, g.src = h, window[m] = function(e) {
                    clearTimeout(c), r(void 0, void 0, "success", e), g.parentNode.removeChild(g), g = null, delete window[m]
            ...
            "GET" !== d && "HEAD" !== d && "OPTIONS" !== d && "DELETE" !== d || !1 === a.cache && (a.url += p + "_nocache" + Date.now());
            var v = new XMLHttpRequest;
            v.requestUrl = a.url, v.requestParameters = a, v.open(d, a.url, a.async, a.user, a.password);
            var b, w = null;
            if (("POST" === d || "PUT" === d || "PATCH" === d) && a.data)
                if (a.processData) {
                    if ([ArrayBuffer, Blob, Document, FormData].indexOf(a.data.constructor) >= 0) w = a.data;
                    else {
                        var C = "---------------------------" + Date.now().toString(16);
                        "multipart/form-data" === a.contentType ? v.setRequestHeader("Content-Type", "multipart/form-data; boundary=" + C) : v.setRequestHeader("Content-Type", a.contentType), w = "";
                        var y = n(a.data);
                        if ("multipart/form-data" === a.contentType) {
                            y = y.split("&");
                            for (var x = [], P = 0; P < y.length; P += 1) x.push('Content-Disposition: form-data; name="' + y[P].split("=")[0] + '"\r\n\r\n' + y[P].split("=")[1] + "\r\n");
                            w = "--" + C + "\r\n" + x.join("--" + C + "\r\n") + "--" + C + "--\r\n"
                        } else w = y
                    }
                } else w = a.data;
            return a.headers && t(a.headers, function(e, a) {
                v.setRequestHeader(e, a)
            }), void 0 === a.crossDomain && (a.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(a.url) && RegExp.$2 !== window.location.host), a.crossDomain || v.setRequestHeader("X-Requested-With", "XMLHttpRequest"), a.xhrFields && t(a.xhrFields, function(e, a) {
                v[e] = a
            }), v.onload = function() {
                var e;
                if (b && clearTimeout(b), v.status >= 200 && v.status < 300 || 0 === v.status)
                    if ("json" === a.dataType) try {
                        e = JSON.parse(v.responseText), r("ajaxSuccess ajax:success", {
                            xhr: v
                        }, "success", e, v.status, v)
                    } catch (e) {
                        r("ajaxError ajax:error", {
                            xhr: v,
                            parseerror: !0
                        }, "error", v, "parseerror")
                    } else e = "text" === v.responseType || "" === v.responseType ? v.responseText : v.response, r("ajaxSuccess ajax:success", {
                        xhr: v
                    }, "success", e, v.status, v);
                    else r("ajaxError ajax:error", {
                        xhr: v
                    }, "error", v, v.status);
                a.statusCode && (o.statusCode && o.statusCode[v.status] && o.statusCode[v.status](v), a.statusCode[v.status] && a.statusCode[v.status](v)), r("ajaxComplete ajax:complete", {
                    xhr: v
                }, "complete", v, v.status)
            }, v.onerror = function() {
                b && clearTimeout(b), r("ajaxError ajax:error", {
                    xhr: v
                }, "error", v, v.status), r("ajaxComplete ajax:complete", {
                    xhr: v,
                    error: !0
                }, "complete", v, "error")
            }, r("ajaxStart ajax:start", {
                xhr: v
            }, "start", v), r(void 0, void 0, "beforeSend", v), a.timeout > 0 && (v.onabort = function() {
                b && clearTimeout(b)
            }, b = setTimeout(function() {
                v.abort(), r("ajaxError ajax:error", {
                    xhr: v,
                    timeout: !0
                }, "error", v, "timeout"), r("ajaxComplete ajax:complete", {
                    xhr: v,
                    timeout: !0
                }, "complete", v, "timeout")
            }, a.timeout)), v.send(w), v
        }

        function d(e) {
            for (var a = [], t = arguments.length - 1; t-- > 0;) a[t] = arguments[t + 1];
            var r, n, i, s, o, l, d;
            "function" == typeof a[1] ? (r = (l = a)[0], i = l[1], s = l[2], o = l[3]) : (r = (d = a)[0], n = d[1], i = d[2], s = d[3], o = d[4]);
            return [i, s].forEach(function(e) {
                "string" == typeof e && (o = e, e === i ? i = void 0 : s = void 0)
            }), o = o || ("getJSON" === e ? "json" : void 0), p({
                url: r,
        ...
        for (var m = [{
                base: "A",
                letters: "AÃ¢â€™Â¶Ã¯Â¼Â¡Ãƒâ‚¬ÃƒÂÃƒâ€šÃ¡ÂºÂ¦Ã¡ÂºÂ¤Ã¡ÂºÂªÃ¡ÂºÂ¨ÃƒÆ’Ã„â‚¬Ã„â€šÃ¡ÂºÂ°Ã¡ÂºÂ®Ã¡ÂºÂ´Ã¡ÂºÂ²ÃˆÂ¦Ã‡ Ãƒâ€žÃ‡Å¾Ã¡ÂºÂ¢Ãƒâ€¦Ã‡ÂºÃ‡ÂÃˆâ‚¬Ãˆâ€šÃ¡Âº Ã¡ÂºÂ¬Ã¡ÂºÂ¶Ã¡Â¸â‚¬Ã„â€žÃˆÂºÃ¢Â±Â¯"
            }, {
                base: "AA",
                letters: "ÃªÅ“Â²"
            }, {
                ...
                base: "AV",
                letters: "ÃªÅ“Â¸ÃªÅ“Âº"
            }, {
                base: "AY",
                letters: "ÃªÅ“Â¼"
            }, {
                base: "B",
                letters: "BÃ¢â€™Â·Ã¯Â¼Â¢Ã¡Â¸â€šÃ¡Â¸â€žÃ¡Â¸â€ Ã‰Æ’Ã†â€šÃ†Â"
            }, {
                base: "C",
                letters: "CÃ¢â€™Â¸Ã¯Â¼Â£Ã„â€ Ã„Ë†Ã„Å Ã„Å’Ãƒâ€¡Ã¡Â¸Ë†Ã†â€¡ÃˆÂ»ÃªÅ“Â¾"
            }, {
                base: "D",
                letters: "DÃ¢â€™Â¹Ã¯Â¼Â¤Ã¡Â¸Å Ã„Å½Ã¡Â¸Å’Ã¡Â¸ÂÃ¡Â¸â€™Ã¡Â¸Å½Ã„ÂÃ†â€¹Ã†Å Ã†â€°ÃªÂÂ¹"
            }, {
                base: "DZ",
                letters: "Ã‡Â±Ã‡â€ž"
            }, {
                ...
                base: "E",
                letters: "EÃ¢â€™ÂºÃ¯Â¼Â¥ÃƒË†Ãƒâ€°ÃƒÅ Ã¡Â»â‚¬Ã¡ÂºÂ¾Ã¡Â»â€žÃ¡Â»â€šÃ¡ÂºÂ¼Ã„â€™Ã¡Â¸â€Ã¡Â¸â€“Ã„â€Ã„â€“Ãƒâ€¹Ã¡ÂºÂºÃ„Å¡Ãˆâ€žÃˆâ€ Ã¡ÂºÂ¸Ã¡Â»â€ ÃˆÂ¨Ã¡Â¸Å“Ã„ËœÃ¡Â¸ËœÃ¡Â¸Å¡Ã†ÂÃ†Å½"
            }, {
                base: "F",
                letters: "FÃ¢â€™Â»Ã¯Â¼Â¦Ã¡Â¸Å¾Ã†â€˜ÃªÂÂ»"
            }, {
                base: "G",
                letters: "GÃ¢â€™Â¼Ã¯Â¼Â§Ã‡Â´Ã„Å“Ã¡Â¸ Ã„Å¾Ã„ Ã‡Â¦Ã„Â¢Ã‡Â¤Ã†â€œÃªÅ¾ ÃªÂÂ½ÃªÂÂ¾"
            }, {
                base: "H",
                letters: "HÃ¢â€™Â½Ã¯Â¼Â¨Ã„Â¤Ã¡Â¸Â¢Ã¡Â¸Â¦ÃˆÅ¾Ã¡Â¸Â¤Ã¡Â¸Â¨Ã¡Â¸ÂªÃ„Â¦Ã¢Â±Â§Ã¢Â±ÂµÃªÅ¾Â"
            }, {
                base: "I",
                letters: "IÃ¢â€™Â¾Ã¯Â¼Â©ÃƒÅ’ÃƒÂÃƒÅ½Ã„Â¨Ã„ÂªÃ„Â¬Ã„Â°ÃƒÂÃ¡Â¸Â®Ã¡Â»Ë†Ã‡ÂÃˆË†ÃˆÅ Ã¡Â»Å Ã„Â®Ã¡Â¸Â¬Ã†â€”"
            }, {
                base: "J",
                letters: "JÃ¢â€™Â¿Ã¯Â¼ÂªÃ„Â´Ã‰Ë†"
            }, {
                base: "K",
                letters: "KÃ¢â€œâ‚¬Ã¯Â¼Â«Ã¡Â¸Â°Ã‡Â¨Ã¡Â¸Â²Ã„Â¶Ã¡Â¸Â´Ã†ËœÃ¢Â±Â©ÃªÂâ‚¬ÃªÂâ€šÃªÂâ€žÃªÅ¾Â¢"
            }, {
                base: "L",
                letters: "LÃ¢â€œÂÃ¯Â¼Â¬Ã„Â¿Ã„Â¹Ã„Â½Ã¡Â¸Â¶Ã¡Â¸Â¸Ã„Â»Ã¡Â¸Â¼Ã¡Â¸ÂºÃ…ÂÃˆÂ½Ã¢Â±Â¢Ã¢Â± ÃªÂË†ÃªÂâ€ ÃªÅ¾â‚¬"
            }, {
                base: "LJ",
                letters: "Ã‡â€¡"
            }, {
                ...
                base: "M",
                letters: "MÃ¢â€œâ€šÃ¯Â¼Â­Ã¡Â¸Â¾Ã¡Â¹â‚¬Ã¡Â¹â€šÃ¢Â±Â®Ã†Å“"
            }, {
                base: "N",
                letters: "NÃ¢â€œÆ’Ã¯Â¼Â®Ã‡Â¸Ã…Æ’Ãƒâ€˜Ã¡Â¹â€žÃ…â€¡Ã¡Â¹â€ Ã…â€¦Ã¡Â¹Å Ã¡Â¹Ë†Ãˆ Ã†ÂÃªÅ¾ÂÃªÅ¾Â¤"
            }, {
                base: "NJ",
                letters: "Ã‡Å "
            }, {
                ...
                base: "O",
                letters: "OÃ¢â€œâ€žÃ¯Â¼Â¯Ãƒâ€™Ãƒâ€œÃƒâ€Ã¡Â»â€™Ã¡Â»ÂÃ¡Â»â€“Ã¡Â»â€Ãƒâ€¢Ã¡Â¹Å’ÃˆÂ¬Ã¡Â¹Å½Ã…Å’Ã¡Â¹ÂÃ¡Â¹â€™Ã…Å½ÃˆÂ®ÃˆÂ°Ãƒâ€“ÃˆÂªÃ¡Â»Å½Ã…ÂÃ‡â€˜ÃˆÅ’ÃˆÅ½Ã† Ã¡Â»Å“Ã¡Â»Å¡Ã¡Â» Ã¡Â»Å¾Ã¡Â»Â¢Ã¡Â»Å’Ã¡Â»ËœÃ‡ÂªÃ‡Â¬ÃƒËœÃ‡Â¾Ã†â€ Ã†Å¸ÃªÂÅ ÃªÂÅ’"
            }, {
                base: "OI",
                letters: "Ã†Â¢"
            }, {
                ...
                base: "P",
                letters: "PÃ¢â€œâ€¦Ã¯Â¼Â°Ã¡Â¹â€Ã¡Â¹â€“Ã†Â¤Ã¢Â±Â£ÃªÂÂÃªÂâ€™ÃªÂâ€"
            }, {
                base: "Q",
                letters: "QÃ¢â€œâ€ Ã¯Â¼Â±ÃªÂâ€“ÃªÂËœÃ‰Å "
            }, {
                base: "R",
                letters: "RÃ¢â€œâ€¡Ã¯Â¼Â²Ã…â€Ã¡Â¹ËœÃ…ËœÃˆÂÃˆâ€™Ã¡Â¹Å¡Ã¡Â¹Å“Ã…â€“Ã¡Â¹Å¾Ã‰Å’Ã¢Â±Â¤ÃªÂÅ¡ÃªÅ¾Â¦ÃªÅ¾â€š"
            }, {
                base: "S",
                letters: "SÃ¢â€œË†Ã¯Â¼Â³Ã¡ÂºÅ¾Ã…Å¡Ã¡Â¹Â¤Ã…Å“Ã¡Â¹ Ã… Ã¡Â¹Â¦Ã¡Â¹Â¢Ã¡Â¹Â¨ÃˆËœÃ…Å¾Ã¢Â±Â¾ÃªÅ¾Â¨ÃªÅ¾â€ž"
            }, {
                base: "T",
                letters: "TÃ¢â€œâ€°Ã¯Â¼Â´Ã¡Â¹ÂªÃ…Â¤Ã¡Â¹Â¬ÃˆÅ¡Ã…Â¢Ã¡Â¹Â°Ã¡Â¹Â®Ã…Â¦Ã†Â¬Ã†Â®ÃˆÂ¾ÃªÅ¾â€ "
            }, {
                base: "TZ",
                letters: "ÃªÅ“Â¨"
            }, {
                base: "U",
                letters: "UÃ¢â€œÅ Ã¯Â¼ÂµÃƒâ„¢ÃƒÅ¡Ãƒâ€ºÃ…Â¨Ã¡Â¹Â¸Ã…ÂªÃ¡Â¹ÂºÃ…Â¬ÃƒÅ“Ã‡â€ºÃ‡â€”Ã‡â€¢Ã‡â„¢Ã¡Â»Â¦Ã…Â®Ã…Â°Ã‡â€œÃˆâ€Ãˆâ€“Ã†Â¯Ã¡Â»ÂªÃ¡Â»Â¨Ã¡Â»Â®Ã¡Â»Â¬Ã¡Â»Â°Ã¡Â»Â¤Ã¡Â¹Â²Ã…Â²Ã¡Â¹Â¶Ã¡Â¹Â´Ã‰â€ž"
            }, {
                base: "V",
                letters: "VÃ¢â€œâ€¹Ã¯Â¼Â¶Ã¡Â¹Â¼Ã¡Â¹Â¾Ã†Â²ÃªÂÅ¾Ã‰â€¦"
            }, {
                base: "VY",
                letters: "ÃªÂ "
            }, {
                base: "W",
                letters: "WÃ¢â€œÅ’Ã¯Â¼Â·Ã¡Âºâ‚¬Ã¡Âºâ€šÃ…Â´Ã¡Âºâ€ Ã¡Âºâ€žÃ¡ÂºË†Ã¢Â±Â²"
            }, {
                base: "X",
                letters: "XÃ¢â€œÂÃ¯Â¼Â¸Ã¡ÂºÅ Ã¡ÂºÅ’"
            }, {
                base: "Y",
                letters: "YÃ¢â€œÅ½Ã¯Â¼Â¹Ã¡Â»Â²ÃƒÂÃ…Â¶Ã¡Â»Â¸ÃˆÂ²Ã¡ÂºÅ½Ã…Â¸Ã¡Â»Â¶Ã¡Â»Â´Ã†Â³Ã‰Å½Ã¡Â»Â¾"
            }, {
                base: "Z",
                letters: "ZÃ¢â€œÂÃ¯Â¼ÂºÃ…Â¹Ã¡ÂºÂÃ…Â»Ã…Â½Ã¡Âºâ€™Ã¡Âºâ€Ã†ÂµÃˆÂ¤Ã¢Â±Â¿Ã¢Â±Â«ÃªÂÂ¢"
            }, {
                base: "a",
                letters: "aÃ¢â€œÂÃ¯Â½ÂÃ¡ÂºÅ¡Ãƒ ÃƒÂ¡ÃƒÂ¢Ã¡ÂºÂ§Ã¡ÂºÂ¥Ã¡ÂºÂ«Ã¡ÂºÂ©ÃƒÂ£Ã„ÂÃ„Æ’Ã¡ÂºÂ±Ã¡ÂºÂ¯Ã¡ÂºÂµÃ¡ÂºÂ³ÃˆÂ§Ã‡Â¡ÃƒÂ¤Ã‡Å¸Ã¡ÂºÂ£ÃƒÂ¥Ã‡Â»Ã‡Å½ÃˆÂÃˆÆ’Ã¡ÂºÂ¡Ã¡ÂºÂ­Ã¡ÂºÂ·Ã¡Â¸ÂÃ„â€¦Ã¢Â±Â¥Ã‰Â"
            }, {
                base: "aa",
                letters: "ÃªÅ“Â³"
            }, {
                ...
                base: "b",
                letters: "bÃ¢â€œâ€˜Ã¯Â½â€šÃ¡Â¸Æ’Ã¡Â¸â€¦Ã¡Â¸â€¡Ã†â‚¬Ã†Æ’Ã‰â€œ"
            }, {
                base: "c",
                letters: "cÃ¢â€œâ€™Ã¯Â½Æ’Ã„â€¡Ã„â€°Ã„â€¹Ã„ÂÃƒÂ§Ã¡Â¸â€°Ã†Ë†ÃˆÂ¼ÃªÅ“Â¿Ã¢â€ â€ž"
            }, {
                base: "d",
                letters: "dÃ¢â€œâ€œÃ¯Â½â€žÃ¡Â¸â€¹Ã„ÂÃ¡Â¸ÂÃ¡Â¸â€˜Ã¡Â¸â€œÃ¡Â¸ÂÃ„â€˜Ã†Å’Ã‰â€“Ã‰â€”ÃªÂÂº"
            }, {
                base: "dz",
                letters: "Ã‡Â³Ã‡â€ "
            }, {
                base: "e",
                letters: "eÃ¢â€œâ€Ã¯Â½â€¦ÃƒÂ¨ÃƒÂ©ÃƒÂªÃ¡Â»ÂÃ¡ÂºÂ¿Ã¡Â»â€¦Ã¡Â»Æ’Ã¡ÂºÂ½Ã„â€œÃ¡Â¸â€¢Ã¡Â¸â€”Ã„â€¢Ã„â€”ÃƒÂ«Ã¡ÂºÂ»Ã„â€ºÃˆâ€¦Ãˆâ€¡Ã¡ÂºÂ¹Ã¡Â»â€¡ÃˆÂ©Ã¡Â¸ÂÃ„â„¢Ã¡Â¸â„¢Ã¡Â¸â€ºÃ‰â€¡Ã‰â€ºÃ‡Â"
            }, {
                base: "f",
                letters: "fÃ¢â€œâ€¢Ã¯Â½â€ Ã¡Â¸Å¸Ã†â€™ÃªÂÂ¼"
            }, {
                base: "g",
                letters: "gÃ¢â€œâ€“Ã¯Â½â€¡Ã‡ÂµÃ„ÂÃ¡Â¸Â¡Ã„Å¸Ã„Â¡Ã‡Â§Ã„Â£Ã‡Â¥Ã‰ ÃªÅ¾Â¡Ã¡ÂµÂ¹ÃªÂÂ¿"
            }, {
                base: "h",
                letters: "hÃ¢â€œâ€”Ã¯Â½Ë†Ã„Â¥Ã¡Â¸Â£Ã¡Â¸Â§ÃˆÅ¸Ã¡Â¸Â¥Ã¡Â¸Â©Ã¡Â¸Â«Ã¡Âºâ€“Ã„Â§Ã¢Â±Â¨Ã¢Â±Â¶Ã‰Â¥"
            }, {
                base: "hv",
                letters: "Ã†â€¢"
            }, {
                base: "i",
                letters: "iÃ¢â€œËœÃ¯Â½â€°ÃƒÂ¬ÃƒÂ­ÃƒÂ®Ã„Â©Ã„Â«Ã„Â­ÃƒÂ¯Ã¡Â¸Â¯Ã¡Â»â€°Ã‡ÂÃˆâ€°Ãˆâ€¹Ã¡Â»â€¹Ã„Â¯Ã¡Â¸Â­Ã‰Â¨Ã„Â±"
            }, {
                base: "j",
                letters: "jÃ¢â€œâ„¢Ã¯Â½Å Ã„ÂµÃ‡Â°Ã‰â€°"
            }, {
                base: "k",
                letters: "kÃ¢â€œÅ¡Ã¯Â½â€¹Ã¡Â¸Â±Ã‡Â©Ã¡Â¸Â³Ã„Â·Ã¡Â¸ÂµÃ†â„¢Ã¢Â±ÂªÃªÂÂÃªÂÆ’ÃªÂâ€¦ÃªÅ¾Â£"
            }, {
                base: "l",
                letters: "lÃ¢â€œâ€ºÃ¯Â½Å’Ã…â‚¬Ã„ÂºÃ„Â¾Ã¡Â¸Â·Ã¡Â¸Â¹Ã„Â¼Ã¡Â¸Â½Ã¡Â¸Â»Ã…Â¿Ã…â€šÃ†Å¡Ã‰Â«Ã¢Â±Â¡ÃªÂâ€°ÃªÅ¾ÂÃªÂâ€¡"
            }, {
                base: "lj",
                letters: "Ã‡â€°"
            }, {
                base: "m",
                letters: "mÃ¢â€œÅ“Ã¯Â½ÂÃ¡Â¸Â¿Ã¡Â¹ÂÃ¡Â¹Æ’Ã‰Â±Ã‰Â¯"
            }, {
                base: "n",
                letters: "nÃ¢â€œÂÃ¯Â½Å½Ã‡Â¹Ã…â€žÃƒÂ±Ã¡Â¹â€¦Ã…Ë†Ã¡Â¹â€¡Ã…â€ Ã¡Â¹â€¹Ã¡Â¹â€°Ã†Å¾Ã‰Â²Ã…â€°ÃªÅ¾â€˜ÃªÅ¾Â¥"
            }, {
                base: "nj",
                letters: "Ã‡Å’"
            }, {
                base: "o",
                letters: "oÃ¢â€œÅ¾Ã¯Â½ÂÃƒÂ²ÃƒÂ³ÃƒÂ´Ã¡Â»â€œÃ¡Â»â€˜Ã¡Â»â€”Ã¡Â»â€¢ÃƒÂµÃ¡Â¹ÂÃˆÂ­Ã¡Â¹ÂÃ…ÂÃ¡Â¹â€˜Ã¡Â¹â€œÃ…ÂÃˆÂ¯ÃˆÂ±ÃƒÂ¶ÃˆÂ«Ã¡Â»ÂÃ…â€˜Ã‡â€™ÃˆÂÃˆÂÃ†Â¡Ã¡Â»ÂÃ¡Â»â€ºÃ¡Â»Â¡Ã¡Â»Å¸Ã¡Â»Â£Ã¡Â»ÂÃ¡Â»â„¢Ã‡Â«Ã‡Â­ÃƒÂ¸Ã‡Â¿Ã‰â€ÃªÂâ€¹ÃªÂÂÃ‰Âµ"
            }, {
                base: "oi",
                letters: "Ã†Â£"
            }, {
                ...
                base: "p",
                letters: "pÃ¢â€œÅ¸Ã¯Â½ÂÃ¡Â¹â€¢Ã¡Â¹â€”Ã†Â¥Ã¡ÂµÂ½ÃªÂâ€˜ÃªÂâ€œÃªÂâ€¢"
            }, {
                base: "q",
                letters: "qÃ¢â€œ Ã¯Â½â€˜Ã‰â€¹ÃªÂâ€”ÃªÂâ„¢"
            }, {
                base: "r",
                letters: "rÃ¢â€œÂ¡Ã¯Â½â€™Ã…â€¢Ã¡Â¹â„¢Ã…â„¢Ãˆâ€˜Ãˆâ€œÃ¡Â¹â€ºÃ¡Â¹ÂÃ…â€”Ã¡Â¹Å¸Ã‰ÂÃ‰Â½ÃªÂâ€ºÃªÅ¾Â§ÃªÅ¾Æ’"
            }, {
                base: "s",
                letters: "sÃ¢â€œÂ¢Ã¯Â½â€œÃƒÅ¸Ã…â€ºÃ¡Â¹Â¥Ã…ÂÃ¡Â¹Â¡Ã…Â¡Ã¡Â¹Â§Ã¡Â¹Â£Ã¡Â¹Â©Ãˆâ„¢Ã…Å¸ÃˆÂ¿ÃªÅ¾Â©ÃªÅ¾â€¦Ã¡Âºâ€º"
            }, {
                base: "t",
                letters: "tÃ¢â€œÂ£Ã¯Â½â€Ã¡Â¹Â«Ã¡Âºâ€”Ã…Â¥Ã¡Â¹Â­Ãˆâ€ºÃ…Â£Ã¡Â¹Â±Ã¡Â¹Â¯Ã…Â§Ã†Â­ÃŠË†Ã¢Â±Â¦ÃªÅ¾â€¡"
            }, {
                base: "tz",
                letters: "ÃªÅ“Â©"
            }, {
                base: "u",
                letters: "uÃ¢â€œÂ¤Ã¯Â½â€¢ÃƒÂ¹ÃƒÂºÃƒÂ»Ã…Â©Ã¡Â¹Â¹Ã…Â«Ã¡Â¹Â»Ã…Â­ÃƒÂ¼Ã‡Å“Ã‡ËœÃ‡â€“Ã‡Å¡Ã¡Â»Â§Ã…Â¯Ã…Â±Ã‡â€Ãˆâ€¢Ãˆâ€”Ã†Â°Ã¡Â»Â«Ã¡Â»Â©Ã¡Â»Â¯Ã¡Â»Â­Ã¡Â»Â±Ã¡Â»Â¥Ã¡Â¹Â³Ã…Â³Ã¡Â¹Â·Ã¡Â¹ÂµÃŠâ€°"
            }, {
                base: "v",
                letters: "vÃ¢â€œÂ¥Ã¯Â½â€“Ã¡Â¹Â½Ã¡Â¹Â¿ÃŠâ€¹ÃªÂÅ¸ÃŠÅ’"
            }, {
                base: "vy",
                letters: "ÃªÂÂ¡"
            }, {
                base: "w",
                letters: "wÃ¢â€œÂ¦Ã¯Â½â€”Ã¡ÂºÂÃ¡ÂºÆ’Ã…ÂµÃ¡Âºâ€¡Ã¡Âºâ€¦Ã¡ÂºËœÃ¡Âºâ€°Ã¢Â±Â³"
            }, {
                base: "x",
                letters: "xÃ¢â€œÂ§Ã¯Â½ËœÃ¡Âºâ€¹Ã¡ÂºÂ"
            }, {
                base: "y",
                letters: "yÃ¢â€œÂ¨Ã¯Â½â„¢Ã¡Â»Â³ÃƒÂ½Ã…Â·Ã¡Â»Â¹ÃˆÂ³Ã¡ÂºÂÃƒÂ¿Ã¡Â»Â·Ã¡Âºâ„¢Ã¡Â»ÂµÃ†Â´Ã‰ÂÃ¡Â»Â¿"
            }, {
                base: "z",
                letters: "zÃ¢â€œÂ©Ã¯Â½Å¡Ã…ÂºÃ¡Âºâ€˜Ã…Â¼Ã…Â¾Ã¡Âºâ€œÃ¡Âºâ€¢Ã†Â¶ÃˆÂ¥Ã‰â‚¬Ã¢Â±Â¬ÃªÂÂ£"
            }], u = {}, h = 0; h < m.length; h += 1)
            for (var f = m[h].letters, g = 0; g < f.length; g += 1) u[f[g]] = m[h].base;
        var v = {
                __utils: !0,
                parseUrlQuery: a,
                parseQuery: a,
                ...
                extend: function e() {
                    for (var a = [], t = arguments.length; t--;) a[t] = arguments[t];
                    for (var r = Object(a[0]), n = 1; n < a.length; n += 1) {
                        var i = a[n];
                        if (void 0 !== i && null !== i)
                            for (var s = Object.keys(Object(i)), o = 0, p = s.length; o < p; o += 1) {
                                var d = s[o],
                                    c = Object.getOwnPropertyDescriptor(i, d);
                                void 0 !== c && c.enumerable && (l(r[d]) && l(i[d]) ? e(r[d], i[d]) : !l(r[d]) && l(i[d]) ? (r[d] = {}, e(r[d], i[d])) : r[d] = i[d])
                            }
                    }
                    return r
                },
                ...
                getTranslate: function(e, a) {
                    ...
                    return window.WebKitCSSMatrix ? ((r = i.transform || i.webkitTransform).split(",").length > 6 && (r = r.split(", ").map(function(e) {
                        return e.replace(",", ".")
                    }).join(", ")), n = new window.WebKitCSSMatrix("none" === r ? "" : r)) : t = (n = i.transform || i.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === a && (r = window.WebKitCSSMatrix ? n.m41 : 16 === t.length ? parseFloat(t[12]) : parseFloat(t[4])), "y" === a && (r = window.WebKitCSSMatrix ? n.m42 : 16 === t.length ? parseFloat(t[13]) : parseFloat(t[5])), r || 0
                }
            },
            b = {
                addClass: function(e) {
                    if (void 0 === e) return this;
                    for (var a = e.split(" "), t = 0; t < a.length; t += 1)
                        for (var r = 0; r < this.length; r += 1) void 0 !== this[r].classList && this[r].classList.add(a[t]);
                    return this
                },
                removeClass: function(e) {
                    for (var a = e.split(" "), t = 0; t < a.length; t += 1)
                        for (var r = 0; r < this.length; r += 1) void 0 !== this[r].classList && this[r].classList.remove(a[t]);
                    return this
                },
                hasClass: function(e) {
                ...
                toggleClass: function(e) {
                    for (var a = e.split(" "), t = 0; t < a.length; t += 1)
                        for (var r = 0; r < this.length; r += 1) void 0 !== this[r].classList && this[r].classList.toggle(a[t]);
                    return this
                },
                attr: function(e, a) {
                    var t = arguments;
                    if (1 !== arguments.length || "string" != typeof e) {
                        for (var r = 0; r < this.length; r += 1)
                            if (2 === t.length) this[r].setAttribute(e, a);
                            else
                ...
                data: function(e, a) {
                    var t;
                    if (void 0 !== a) {
                        for (var r = 0; r < this.length; r += 1) t = this[r], t.dom7ElementDataStorage || (t.dom7ElementDataStorage = {}), t.dom7ElementDataStorage[e] = a;
                        return this
                    }
                    if (t = this[0]) {
                    ...
                    if (e) {
                        ...
                        if (e.dataset)
                            ...
                            for (var r = 0; r < e.attributes.length; r += 1) {
                                ...
                                n.name.indexOf("data-") >= 0 && (a[i(n.name.split("data-")[1])] = n.value)
                            }
                        for (var s in a) "false" === a[s] ? a[s] = !1 : "true" === a[s] ? a[s] = !0 : parseFloat(a[s]) === 1 * a[s] && (a[s] *= 1);
                        return a
                    }
                },
                val: function(e) {
                    if (void 0 !== e) {
                        for (var a = 0; a < this.length; a += 1) this[a].value = e;
                        return this
                    }
                    if (this[0]) {
                        if (this[0].multiple && "select" === this[0].nodeName.toLowerCase()) {
                            for (var t = [], r = 0; r < this[0].selectedOptions.length; r += 1) t.push(this[0].selectedOptions[r].value);
                            return t
                        }
                        return this[0].value
                    }
                ...
                on: function() {
                    function a(a) {
                        ...
                        if (t) {
                            ...
                            if (r.unshift(a), e(t).is(i)) s.apply(t, r);
                            else
                                for (var n = e(t).parents(), o = 0; o < n.length; o += 1) e(n[o]).is(i) && s.apply(n[o], r)
                        }
                    }

                    function t(e) {
                        var a = e && e.target && e.target.dom7EventData || [];
                        a.unshift(e), s.apply(this, a)
                    }
                    for (var r = [], n = arguments.length; n--;) r[n] = arguments[n];
                    var i, s, o = r[0],
                        l = !1;
                    "function" == typeof r[1] ? (i = !1, s = r[1], l = r[2]) : (i = r[1], s = r[2], l = r[3]);
                    for (var p, d = o.split(" "), c = 0; c < this.length; c += 1) {
                        var m = this[c];
                        if (i)
                            for (p = 0; p < d.length; p += 1) m.dom7LiveListeners || (m.dom7LiveListeners = []), m.dom7LiveListeners.push({
                                type: o,
                                listener: s,
                                proxyListener: a
                            }), m.addEventListener(d[p], a, l);
                        else
                            for (p = 0; p < d.length; p += 1) m.dom7Listeners || (m.dom7Listeners = []), m.dom7Listeners.push({
                                type: o,
                                listener: s,
                                proxyListener: t
                            }), m.addEventListener(d[p], t, l)
                    }
                    return this
                },
                off: function() {
                    ...
                    var t, r, n = e[0],
                        i = !1;
                    "function" == typeof e[1] ? (t = !1, r = e[1], i = e[2]) : (t = e[1], r = e[2], i = e[3]);
                    for (var s = n.split(" "), o = 0; o < s.length; o += 1)
                        for (var l = 0; l < this.length; l += 1) {
                            var p = this[l];
                            if (t) {
                                if (p.dom7LiveListeners)
                                    for (var d = 0; d < p.dom7LiveListeners.length; d += 1) r ? p.dom7LiveListeners[d].listener === r && p.removeEventListener(s[o], p.dom7LiveListeners[d].proxyListener, i) : p.dom7LiveListeners[d].type === s[o] && p.removeEventListener(s[o], p.dom7LiveListeners[d].proxyListener, i)
                            } else if (p.dom7Listeners)
                                for (var c = 0; c < p.dom7Listeners.length; c += 1) r ? p.dom7Listeners[c].listener === r && p.removeEventListener(s[o], p.dom7Listeners[c].proxyListener, i) : p.dom7Listeners[c].type === s[o] && p.removeEventListener(s[o], p.dom7Listeners[c].proxyListener, i)
                        }
                    return this
                },
                once: function(e, a, t, r) {
                    var n = this;
                    return "function" == typeof a && (t = arguments[1], r = arguments[2], a = !1), n.on(e, a, function i(s) {
                        var o = s.target.dom7EventData || [];
                        t.apply(this, o), n.off(e, a, i, r)
                    }, r)
                },
                trigger: function() {
                    for (var e = [], a = arguments.length; a--;) e[a] = arguments[a];
                    for (var t = e[0].split(" "), r = e[1], n = 0; n < t.length; n += 1)
                        for (var i = 0; i < this.length; i += 1) {
                            var s = void 0;
                            try {
                                s = new window.CustomEvent(t[n], {
                                    detail: r,
                                    bubbles: !0,
                                    cancelable: !0
                                })
                            } catch (e) {
                                (s = document.createEvent("Event")).initEvent(t[n], !0, !0), s.detail = r
                            }
                            this[i].dom7EventData = e.filter(function(e, a) {
                                return a > 0
                            }), this[i].dispatchEvent(s), this[i].dom7EventData = [], delete this[i].dom7EventData
                        }
                    return this
                },
                ...
                show: function() {
                    for (var e = 0; e < this.length; e += 1) {
                        var a = this[e];
                        "none" === a.style.display && (a.style.display = ""), "none" === window.getComputedStyle(a, null).getPropertyValue("display") && (a.style.display = "block")
                    }
                    return this
                },
                styles: function() {
                ...
                css: function(e, a) {
                    ...
                    if (2 === arguments.length && "string" == typeof e) {
                        for (t = 0; t < this.length; t += 1) this[t].style[e] = a;
                        return this
                    }
                    return this
                },
                toArray: function() {
                    for (var e = [], a = 0; a < this.length; a += 1) e.push(this[a]);
                    return e
                },
                each: function(e) {
                    if (!e) return this;
                ...
                forEach: function(e) {
                    if (!e) return this;
                    for (var a = 0; a < this.length; a += 1)
                        if (!1 === e.call(this[a], this[a], a)) return this;
                    return this
                },
                filter: function(e) {
                    for (var a = [], t = 0; t < this.length; t += 1) e.call(this[t], t, this[t]) && a.push(this[t]);
                    return new c(a)
                },
                map: function(e) {
                    for (var a = [], t = 0; t < this.length; t += 1) a.push(e.call(this[t], t, this[t]));
                    return new c(a)
                },
                html: function(e) {
                ...
                eq: function(e) {
                    if (void 0 === e) return this;
                    var a, t = this.length;
                    return e > t - 1 ? new c([]) : e < 0 ? new c((a = t + e) < 0 ? [] : [this[a]]) : new c([this[e]])
                },
                append: function() {
                    for (var e = [], a = arguments.length; a--;) e[a] = arguments[a];
                ...
                insertBefore: function(a) {
                    for (var t = e(a), r = 0; r < this.length; r += 1)
                        if (1 === t.length) t[0].parentNode.insertBefore(this[r], t[0]);
                        else if (t.length > 1)
                        for (var n = 0; n < t.length; n += 1) t[n].parentNode.insertBefore(this[r].cloneNode(!0), t[n])
                },
                insertAfter: function(a) {
                    for (var t = e(a), r = 0; r < this.length; r += 1)
                        if (1 === t.length) t[0].parentNode.insertBefore(this[r], t[0].nextSibling);
                        else if (t.length > 1)
                        for (var n = 0; n < t.length; n += 1) t[n].parentNode.insertBefore(this[r].cloneNode(!0), t[n].nextSibling)
                },
                next: function(a) {
                ...
                parent: function(a) {
                    for (var t = [], n = 0; n < this.length; n += 1) null !== this[n].parentNode && (a ? e(this[n].parentNode).is(a) && t.push(this[n].parentNode) : t.push(this[n].parentNode));
                    return e(r(t))
                },
                parents: function(a) {
                    for (var t = [], n = 0; n < this.length; n += 1)
                        for (var i = this[n].parentNode; i;) a ? e(i).is(a) && t.push(i) : t.push(i), i = i.parentNode;
                    return e(r(t))
                },
                closest: function(e) {
                    var a = this;
                ...
                find: function(e) {
                    for (var a = [], t = 0; t < this.length; t += 1)
                        for (var r = this[t].querySelectorAll(e), n = 0; n < r.length; n += 1) a.push(r[n]);
                    return new c(a)
                },
                children: function(a) {
                    for (var t = [], n = 0; n < this.length; n += 1)
                        for (var i = this[n].childNodes, s = 0; s < i.length; s += 1) a ? 1 === i[s].nodeType && e(i[s]).is(a) && t.push(i[s]) : 1 === i[s].nodeType && t.push(i[s]);
                    return new c(r(t))
                },
                remove: function() {
                ...
                add: function() {
                    ...
                    for (r = 0; r < a.length; r += 1) {
                        var i = e(a[r]);
                        for (n = 0; n < i.length; n += 1) this[this.length] = i[n], this.length += 1
                    }
                    return this
                },
                empty: function() {
                    for (var e = 0; e < this.length; e += 1) {
                        var a = this[e];
                        if (1 === a.nodeType) {
                            for (var t = 0; t < a.childNodes.length; t += 1) a.childNodes[t].parentNode && a.childNodes[t].parentNode.removeChild(a.childNodes[t]);
                            a.textContent = ""
                        }
                    }
                    return this
            ...
            w = "click blur focus focusin focusout keyup keydown keypress submit change mousedown mousemove mouseup mouseenter mouseleave mouseout mouseover touchstart touchend touchmove resize scroll".split(" "),
            C = "resize scroll".split(" ");
        for (h = 0; h < w.length; h += 1) ! function(a) {
            b[a] = function(t, r, n) {
                if (void 0 === t) {
                    for (var i = 0; i < this.length; i += 1) C.indexOf(a) < 0 && (a in this[i] ? this[i][a]() : e(this[i]).trigger(a));
                    return this
                }
        ...
        var y = {
                scrollTo: function() {
                    ...
                    var t, r = e[0],
                        ...
                        o = e[3],
                        l = e[4];
                    4 === e.length && "function" == typeof o && (l = o, r = (t = e)[0], n = t[1], i = t[2], l = t[3], o = t[4]);
                    return void 0 === o && (o = "swing"), this.each(function() {
                        var e, a, t, p, d, c, m, u, h = this,
                            f = n > 0 || 0 === n,
                            g = r > 0 || 0 === r;
                        if (void 0 === o && (o = "swing"), f && (e = h.scrollTop, i || (h.scrollTop = n)), g && (a = h.scrollLeft, i || (h.scrollLeft = r)), i) {
                            f && (t = h.scrollHeight - h.offsetHeight, d = Math.max(Math.min(n, t), 0)), g && (p = h.scrollWidth - h.offsetWidth, c = Math.max(Math.min(r, p), 0));
                            var v = null;
                            f && d === e && (f = !1), g && c === a && (g = !1), s(function t(r) {
                                void 0 === r && (r = (new Date).getTime()), null === v && (v = r);
                                var n, p = Math.max(Math.min((r - v) / i, 1), 0),
                                    b = "linear" === o ? p : .5 - Math.cos(p * Math.PI) / 2;
                                f && (m = e + b * (d - e)), g && (u = a + b * (c - a)), f && d > e && m >= d && (h.scrollTop = d, n = !0), f && d < e && m <= d && (h.scrollTop = d, n = !0), g && c > a && u >= c && (h.scrollLeft = c, n = !0), g && c < a && u <= c && (h.scrollLeft = c, n = !0), n ? l && l() : (f && (h.scrollTop = m), g && (h.scrollLeft = u), s(t))
                            })
                        }
                    })
                },
                scrollTop: function() {
                    ...
                    var t, r = e[0],
                        ...
                        i = e[2],
                        s = e[3];
                    3 === e.length && "function" == typeof i && (r = (t = e)[0], n = t[1], s = t[2], i = t[3]);
                ...
                animate: function(a, t) {
                    var r = this,
                        n = {
                            ...
                            stop: function() {
                                n.frameId && o(n.frameId), n.animating = !1, n.elements.each(function(e, a) {
                            ...
                            animate: function(e, a) {
                                ...
                                var t = [];
                                n.elements.each(function(a, r) {
                                    var i, s, o, l, p;
                                    r.dom7AnimateInstance || (n.elements[a].dom7AnimateInstance = n), t[a] = {
                                        container: r
                                    }, Object.keys(e).forEach(function(n) {
                                        i = window.getComputedStyle(r, null).getPropertyValue(n).replace(",", "."), s = parseFloat(i), o = i.replace(s, ""), l = parseFloat(e[n]), p = e[n] + o, t[a][n] = {
                                            initialFullValue: i,
                                            initialValue: s,
                                            unit: o,
                                            finalValue: l,
                                ...
                                var i, o, l = null,
                                    ...
                                    d = 0,
                                    c = !1;
                                return n.animating = !0, n.frameId = s(function m() {
                                    var u, h;
                                    i = (new Date).getTime(), c || (c = !0, a.begin && a.begin(r)), null === l && (l = i), a.progress && a.progress(r, Math.max(Math.min((i - l) / a.duration, 1), 0), l + a.duration - i < 0 ? 0 : l + a.duration - i, l), t.forEach(function(r) {
                                        var s = r;
                                        o || s.done || Object.keys(e).forEach(function(r) {
                                            if (!o && !s.done) {
                                                u = Math.max(Math.min((i - l) / a.duration, 1), 0), h = n.easingProgress(a.easing, u);
                                                var c = s[r],
                                                    m = c.initialValue,
                                                    f = c.finalValue,
                                                    g = c.unit;
                                                s[r].currentValue = m + h * (f - m);
                                                var v = s[r].currentValue;
                                                if ((f > m && v >= f || f < m && v <= f) && (s.container.style[r] = f + g, (d += 1) === Object.keys(e).length && (s.done = !0, p += 1), p === t.length && (o = !0)), o) return void n.done(a.complete);
                                                s.container.style[r] = v + g
                                            }
                                        })
                                    }), o || (n.frameId = s(m))
                                }), n
                    ...
                    for (var i, l = 0; l < n.elements.length; l += 1) n.elements[l].dom7AnimateInstance ? i = n.elements[l].dom7AnimateInstance : n.elements[l].dom7AnimateInstance = n;
            ...
            P = {
                ...
                ajaxSetup: function(e) {
                    e.type && !e.method && (e.method = e.type), t(e, function(e, a) {
                        T[e] = a
                    })
                },
                ajax: p,
                get: function() {
                    for (var e = [], a = arguments.length; a--;) e[a] = arguments[a];
                    return e.unshift("get"), d.apply(this, e)
                },
                post: function() {
                    for (var e = [], a = arguments.length; a--;) e[a] = arguments[a];
                    return e.unshift("post"), d.apply(this, e)
                },
                getJSON: function() {
                    for (var e = [], a = arguments.length; a--;) e[a] = arguments[a];
                    return e.unshift("getJSON"), d.apply(this, e)
                }
            };
        return e.use(v, b, y, x, P), e
        ...
        var o = new RegExp("'", "g"),
            ...
            p = function(a) {
                function r(e, a, t) {
                    ...
                    var r, n, i = a,
                        s = 0;
                    0 === e.indexOf("../") ? (s = e.split("../").length - 1, i = "ctx_" + ((n = i.split("_")[1] - s) >= 1 ? n : 1), r = e.split("../")[s].split(".")) : 0 === e.indexOf("@global") ? (i = "Template7.global", r = e.split("@global.")[1].split(".")) : 0 === e.indexOf("@root") ? (i = "root", r = e.split("@root.")[1].split(".")) : r = e.split(".");
                ...
                function n(e, a, t) {
                    for (var n = [], i = 0; i < e.length; i += 1) /^['"]/.test(e[i]) ? n.push(e[i]) : /^(true|false|\d+)$/.test(e[i]) ? n.push(e[i]) : n.push(r(e[i], a, t));
                    return n.join(", ")
                }

                function i(a, l) {
                    function p(e, a) {
                        return e.content ? i(e.content, a) : function() {
                            return ""
                        }
                    }

                    function d(e, a) {
                        return e.inverseContent ? i(e.inverseContent, a) : function() {
                            return ""
                        }
                    }
                    if (void 0 === a && (a = o.template), void 0 === l && (l = 1), "string" != typeof a) throw new Error("Template7: Template must be a string");
                    var c = function(a) {
                            var r, n, i = [];
                            if (!a) return [];
                            var s = a.split(/({{[^{^}]*}})/);
                    ...
                    var h, f = "";
                    for (f += 1 === l ? "(function (" + m + ", " + u + ", root) {\n" : "(function (" + m + ", " + u + ") {\n", 1 === l && (f += "function isArray(arr){return Object.prototype.toString.apply(arr) === '[object Array]';}\n", f += "function isFunction(func){return (typeof func === 'function');}\n", f += 'function c(val, ctx) {if (typeof val !== "undefined" && val !== null) {if (isFunction(val)) {return val.call(ctx);} else return val;} else return "";}\n', f += "root = root || ctx_1 || {};\n"), f += "var r = '';\n", h = 0; h < c.length; h += 1) {
                        var g = c[h];
                        if ("plain" !== g.type) {
                            var v = void 0,
                                b = void 0;
                            if ("variable" === g.type && (f += "r += c(" + (v = r(g.contextName, m, u)) + ", " + m + ");"), "helper" === g.type) {
                                var w = void 0;
                                if ("ctx_1" !== m) {
                                    for (var C = m.split("_")[1], y = "ctx_" + (C - 1), x = C - 2; x >= 1; x -= 1) y += ", ctx_" + x;
                                    w = "[" + y + "]"
                                } else w = "[" + m + "]";
                                if (g.helperName in o.helpers) b = n(g.contextName, m, u), f += "r += (Template7.helpers." + g.helperName + ").call(" + m + ", " + (b && b + ", ") + "{hash:" + JSON.stringify(g.hash) + ", data: " + u + " || {}, fn: " + p(g, l + 1) + ", inverse: " + d(g, l + 1) + ", root: root, parents: " + w + "});";
                                else {
                                    if (g.contextName.length > 0) throw new Error('Template7: Missing helper: "' + g.helperName + '"');
                                    f += "if (" + (v = r(g.helperName, m, u)) + ") {", f += "if (isArray(" + v + ")) {", f += "r += (Template7.helpers.each).call(" + m + ", " + v + ", {hash:" + JSON.stringify(g.hash) + ", data: " + u + " || {}, fn: " + p(g, l + 1) + ", inverse: " + d(g, l + 1) + ", root: root, parents: " + w + "});", f += "}else {", f += "r += (Template7.helpers.with).call(" + m + ", " + v + ", {hash:" + JSON.stringify(g.hash) + ", data: " + u + " || {}, fn: " + p(g, l + 1) + ", inverse: " + d(g, l + 1) + ", root: root, parents: " + w + "});", f += "}}"
                                }
                            }
                        } else f += "r +='" + g.content.replace(/\r/g, "\\r").replace(/\n/g, "\\n").replace(/'/g, "\\'") + "';"
                    }
                    return f += "\nreturn r;})", eval.call(s, f)
                }
                var o = this;
                o.template = a, o.compile = function(e) {
                    return o.compiled || (o.compiled = i(e)), o.compiled
                }
            };
        return p.prototype = {
            options: {},
            ...
            helpers: {
                _partial: function(e, a) {
                    ...
                    for (var r in a.hash) this[r] = a.hash[r];
                    return t.compiled(this, a.data, a.root)
                },
                escape: function(e, a) {
                    if ("string" != typeof e) throw new Error('Template7: Passed context to "escape" helper should be a string');
                    return t = e, (void 0 !== s && s.escape ? s.escape(t) : t).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
                    var t
                },
                if: function(e, t) {
                    var r = e;
                    ...
                    return "index first last key".split(" ").forEach(function(e) {
                        if (void 0 !== i[e]) {
                            var a = new RegExp("this.@" + e, "g"),
                                t = new RegExp("@" + e, "g");
                            o = o.replace(a, JSON.stringify(i[e])).replace(t, JSON.stringify(i[e]))
                        }
                    }), a.root && o.indexOf("@root") >= 0 && (o = r(o, "@root", a.root)), o.indexOf("@global") >= 0 && (o = r(o, "@global", s.Template7.global)), o.indexOf("../") >= 0 && (o = n(o, a.parents)), t = o.indexOf("return") >= 0 ? "(function(){" + o + "})" : "(function(){return (" + o + ")})", eval.call(this, t).call(this)
                },
                js_if: function(e, a) {
                    var t, i = a.data,
                        s = e;
                    return "index first last key".split(" ").forEach(function(e) {
                        if (void 0 !== i[e]) {
                            var a = new RegExp("this.@" + e, "g"),
                                t = new RegExp("@" + e, "g");
                            s = s.replace(a, JSON.stringify(i[e])).replace(t, JSON.stringify(i[e]))
                        }
                    }), a.root && s.indexOf("@root") >= 0 && (s = r(s, "@root", a.root)), s.indexOf("@global") >= 0 && (s = r(s, "@global", p.global)), s.indexOf("../") >= 0 && (s = n(s, a.parents)), t = s.indexOf("return") >= 0 ? "(function(){" + s + "})" : "(function(){return (" + s + ")})", eval.call(this, t).call(this) ? a.fn(this, a.data) : a.inverse(this, a.data)
                }
            }
        }, p.prototype.helpers.js_compare = p.prototype.helpers.js_if, i.registerHelper = function(e, a) {
    ...
    function() {
        ...
        window.Framework7 = function(e) {
            ...
            var o = function(e, a) {
                ...
                (a = a || {}).dynamicNavbar && r.params.material && (a.dynamicNavbar = !1);
                ...
                if (o.handleTouchStart = function(e) {
                        ...
                        if (E) {
                            ...
                            if (!O) {
                                ...
                                p.length > 0 && (!r.rtl && p.find(".swipeout-actions-left").length > 0 && (n = !0), r.rtl && p.find(".swipeout-actions-right").length > 0 && (n = !0)), (D = s.is(".page") ? s : s.parents(".page")).hasClass("no-swipeback") && (n = !0), z = l.find(".page-on-left:not(.cached)");
                                L.x, l.offset().left, o.params.swipeBackPageActiveArea;
                                if ((r.rtl ? L.x < l.offset().left - l[0].scrollLeft + b - o.params.swipeBackPageActiveArea : L.x - l.offset().left > o.params.swipeBackPageActiveArea) && (n = !0), 0 !== z.length && 0 !== D.length || (n = !0), n) return void(E = !1);
                            ...
                            var d = r.rtl ? -1 : 1;
                            (w = (a - L.x - o.params.swipeBackPageThreshold) * d) < 0 && (w = 0);
                            var c = w / b,
                                m = {
                                    percentage: c,
                                    activePage: D[0],
                            ...
                            var u = w * d,
                                h = (w / 5 - b / 5) * d;
                            if (1 === r.device.pixelRatio && (u = Math.round(u), h = Math.round(h)), D.transform("translate3d(" + u + "px,0,0)"), o.params.swipeBackPageAnimateShadow && !r.device.android && (S[0].style.opacity = 1 - 1 * c), z.transform("translate3d(" + h + "px,0,0)"), o.params.swipeBackPageAnimateOpacity && (M[0].style.opacity = 1 - 1 * c), P) {
                                var f;
                                for (f = 0; f < y.length; f++)
                                    if (I = i(y[f]), I.is(".subnavbar.sliding") || (I[0].style.opacity = 1 - 1.3 * c), I[0].className.indexOf("sliding") >= 0) {
                                        var g = c * I[0].f7NavbarRightOffset;
                                        1 === r.device.pixelRatio && (g = Math.round(g)), I.transform("translate3d(" + g + "px,0,0)"), r.params.animateNavBackIcon && I[0].className.indexOf("left") >= 0 && T.length > 0 && T.transform("translate3d(" + -g + "px,0,0)")
                                    }
                                for (f = 0; f < x.length; f++)
                                    if (I = i(x[f]), I.is(".subnavbar.sliding") || (I[0].style.opacity = 1.3 * c - .3), I[0].className.indexOf("sliding") >= 0) {
                                        var C = I[0].f7NavbarLeftOffset * (1 - c);
                                        1 === r.device.pixelRatio && (C = Math.round(C)), I.transform("translate3d(" + C + "px,0,0)"), r.params.animateNavBackIcon && I[0].className.indexOf("left") >= 0 && k.length > 0 && k.transform("translate3d(" + -C + "px,0,0)")
                                    }
                            }
                        }
                    ...
                    var H, R = c.split(f)[1];
                    g ? H = c.split(r.params.pushStateRoot + f)[1] : f && c.indexOf(f) >= 0 && c.indexOf(f + "#") < 0 && (H = R);
                    ...
                    H ? H.indexOf("#") >= 0 && o.params.domCache && Y && Y.pageName && "viewIndex" in Y ? r.router.load(o, {
                        ...
                        animatePages: V,
                        pushState: !1
                    }) : o.params.domCache && c.indexOf(f + "#") >= 0 && (Y && Y.pageName && "viewIndex" in Y ? r.router.load(o, {
                        pageName: Y.pageName,
                        url: Y.url,
                        animatePages: V,
                        pushState: !1
                    }) : f && 0 === R.indexOf("#") && o.initialPagesUrl.indexOf(R) && r.router.load(o, {
                        pageName: R.replace("#", ""),
                        animatePages: V,
                        pushState: !1
                    }))
            ...
            r.addView = function(e, a) {
                ...
                if (s.length > 0) {
                    ...
                    if (s.length > 1) {
                        ...
                        return o.length > 0 && void 0 !== e ? o[e] : o.length > 1 ? o : 1 === o.length ? o[0] : void 0
                    }
                }
                ...
                var a, t = (e = i(e)).parents("." + r.params.viewClass);
            ...
            r.searchbar = function(e, a) {
                return new function(e, a) {
                    ...
                    o.setCancelButtonMargin = function() {
                        ...
                        if (!o.query && e && i(e.target).hasClass("searchbar-clear")) o.disable();
                        else {
                            var a = o.value;
                        ...
                        if (!c || e.trim() !== c) {
                            ...
                            if (o.isVirtualList) {
                                ...
                                s = o.params.removeDiacritics ? i.removeDiacritics(e.trim().toLowerCase()).split(" ") : e.trim().toLowerCase().split(" "), o.searchList.find("li").removeClass("hidden-by-searchbar").each(function(e, a) {
                                    var t = [];
                                    (a = i(a)).find(o.params.searchIn).each(function() {
                ...
                var t = (e = i(e)).hasClass("searchbar") ? e : e.find(".searchbar");
            ...
            r.messagebar = function(e, a) {
                return new function(e, a) {
                    ...
                    if (s.params = a, s.container = i(e), 0 !== s.container.length) return s.textarea = s.params.textarea ? i(s.params.textarea) : s.container.find("textarea"), s.pageContainer = s.container.parents(".page").eq(0), s.pageContent = s.pageContainer.find(".page-content"), s.pageContentPadding = parseInt(s.pageContent.css("padding-bottom")), s.initialBarHeight = s.container[0].offsetHeight, s.initialAreaHeight = s.textarea[0].offsetHeight, s.sizeTextarea = function() {
                        ...
                        if (t + a > e) {
                            ...
                            n > i && (r = (n = parseInt(i, 10)) - s.initialBarHeight + s.initialAreaHeight), s.textarea.css("height", r + "px"), s.container.css("height", n + "px");
                ...
                var a = (e = i(e)).hasClass("messagebar") ? e : e.find(".messagebar");
                if (0 !== a.length && a.hasClass("messagebar-init")) {
                    var t = r.messagebar(a, a.dataset());
                    e.hasClass("page") && e.on("page:beforeremove", function a() {
                        t.destroy(), e.off("page:beforeremove", a)
                    })
                }
            ...
            for (var l = "beforeInit init reinit beforeAnimation afterAnimation back afterBack beforeRemove".split(" "), p = 0; p < l.length; p++) r.pageCallbacks[l[p]] = {},
                function(e) {
            ...
            r.triggerPageCallbacks = function(e, a, t) {
                ...
                var n, s, o, l, p, d, c, m, u, h = a.url,
                    ...
                    T = a.pushState,
                    k = a.pageElement;
                if (void 0 === y && (y = e.params.animatePages), (r.params.template7Pages && "string" == typeof f || v) && ((g = r.router.template7Render(e, a)).content && !f && (f = g.content)), r.router.temporaryDom.innerHTML = "", !b && !k)
                ...
                if (u = a.reload && (a.reloadPrevious ? "left" : "center"), !(n = b ? C.find('.page[data-page="' + b + '"]') : k ? i(k) : r.router.findElement(".page", r.router.temporaryDom, e)) || 0 === n.length || b && e.activePage && e.activePage.name === b) e.allowPageChange = !0;
                else if (n.addClass(a.reload ? "page-on-" + u : "page-on-right"), o = C.children(".page:not(.cached)"), k && (o = o.filter(function(e, a) {
                        if (a !== k) return a
                    })), a.reload && a.reloadPrevious && 1 === o.length) e.allowPageChange = !0;
                else {
                ...
                function t() {
                    ...
                    }), r.router.afterBack(e, o[0], l[0])
                }

                function n() {
                    if (r.router.temporaryDom.innerHTML = "", "string" == typeof f || h && "string" == typeof f) r.router.temporaryDom.innerHTML = g.content;
                    else if ("length" in f && f.length > 1)
                        for (var a = 0; a < f.length; a++) i(r.router.temporaryDom).append(f[a]);
                    else i(r.router.temporaryDom).append(f);
                    l = T ? i(T) : r.router.findElement(".page", r.router.temporaryDom, e), e.params.dynamicNavbar && (d = r.router.findElement(".navbar-inner", r.router.temporaryDom, e))
                }

                function s() {
                    if (l && 0 !== l.length) {
                        if (e.params.dynamicNavbar && void 0 === u && (u = !(!d || 0 === d.length)), l.addClass("page-on-left").removeClass("cached"), u && (c = k.children(".navbar"), m = c.find(".navbar-inner:not(.cached)"), d.addClass("navbar-on-left").removeClass("cached")), y) {
                            var n, s;
                            if (n = i(S[S.length - 2]), u && (s = i(n[0] && n[0].f7RelatedNavbar || m[m.length - 2])), e.params.domCache && e.initialPages.indexOf(n[0]) >= 0) n.length && n[0] !== l[0] && n.addClass("cached"), u && s.length && s[0] !== d[0] && s.addClass("cached");
                            else {
                                var f = u && s.length;
                                n.length ? (r.pageRemoveCallback(e, n[0], "right"), f && r.navbarRemoveCallback(e, n[0], c[0], s[0]), r.router._remove(n), f && r.router._remove(s)) : f && (r.navbarRemoveCallback(e, n[0], c[0], s[0]), r.router._remove(s))
                            }
                            S = P.children(".page:not(.cached)"), u && (m = k.children(".navbar").find(".navbar-inner:not(.cached)")), e.history.indexOf(h) >= 0 ? e.history = e.history.slice(0, e.history.indexOf(h) + 2) : e.history[[e.history.length - 2]] ? e.history[e.history.length - 2] = h : e.history.unshift(h)
                        }
                        o = i(S[S.length - 1]), e.params.domCache && o[0] === l[0] && (0 === (o = P.children(".page.page-on-center")).length && e.activePage && (o = i(e.activePage.container))), u && !p && (p = i(m[m.length - 1]), e.params.domCache && (p[0] === d[0] && (p = c.children(".navbar-inner.navbar-on-center:not(.cached)")), 0 === p.length && (p = c.children('.navbar-inner[data-page="' + o.attr("data-page") + '"]'))), 0 !== p.length && d[0] !== p[0] || (u = !1)), u && (M && d.insertBefore(p), d[0].f7RelatedPage = l[0], l[0].f7RelatedNavbar = d[0]), M && l.insertBefore(o), r.pageInitCallback(e, {
                            pageContainer: l[0],
                            url: h,
                            position: "left",
                            navbarInnerContainer: u ? d[0] : void 0,
                            oldNavbarInnerContainer: u ? p && p[0] : void 0,
                            context: g.context,
                            query: a.query,
                            fromPage: o && o.length && o[0].f7PageData,
                            preloadOnly: w
                        }), u && r.navbarInitCallback(e, l[0], c[0], d[0], h, "right"), u && d.hasClass("navbar-on-left") && b && r.router.prepareNavbar(d, p, "left"), w ? e.allowPageChange = !0 : (e.url = h, l[0].clientLeft, r.pageBackCallback("before", e, {
                            pageContainer: o[0],
                            url: h,
                            position: "center",
                            oldPage: o,
                            ...
                            query: a.query,
                            fromPage: o && o.length && o[0].f7PageData
                        }), b ? (r.router.animatePages(l, o, "to-right", e), u && setTimeout(function() {
                            r.router.animateNavbars(d, p, "to-right", e)
                        }, 0), l.animationEnd(function() {
                            t()
                        })) : (u && d.find(".sliding, .sliding .back .icon").transform(""), t()), r.params.pushState && e.main && (void 0 === C && (C = !0), !w && history.state && C && history.back()))
                    } else e.allowPageChange = !0
                }
                a = a || {}, r.pluginHook("routerBack", e, a);
                var o, l, p, d, c, m, u, h = a.url,
                    f = a.content,
                    g = {
                        content: a.content
                    },
                    ...
                    w = a.preloadOnly,
                    C = a.pushState,
                    y = (a.ignoreCache, a.force),
                    x = a.pageName,
                    T = a.pageElement,
                    k = i(e.container),
                    P = i(e.pagesContainer),
                    S = P.children(".page:not(.cached)"),
                    M = !0;
                return void 0 === b && (b = e.params.animatePages), (r.params.template7Pages && "string" == typeof f || v) && ((g = r.router.template7Render(e, a)).content && !f && (f = g.content)), S.length > 1 && !y ? w ? void(e.allowPageChange = !0) : (e.url = e.history[e.history.length - 2], h = e.url, l = i(S[S.length - 2]), o = i(S[S.length - 1]), e.params.dynamicNavbar && (u = !0, m = k.children(".navbar").find(".navbar-inner:not(.cached)"), d = i(m[0]), p = i(m[1]), 0 !== d.length && 0 !== p.length && p[0] !== d[0] || (u = !1)), M = !1, void s()) : y ? h && h === e.url || x && e.activePage && e.activePage.name === x ? void(e.allowPageChange = !0) : f ? (n(), void s()) : x && e.params.domCache ? (x && (h = "#" + x), (l = i(k).find('.page[data-page="' + x + '"]'))[0].f7PageData && l[0].f7PageData.url && (h = l[0].f7PageData.url), e.params.dynamicNavbar && (0 === (d = i(k).children(".navbar").find('.navbar-inner[data-page="' + x + '"]')).length && l[0].f7RelatedNavbar && (d = i(l[0].f7RelatedNavbar)), 0 === d.length && l[0].f7PageData && (d = i(l[0].f7PageData.navbarInnerContainer))), void s()) : T && h ? (l = i(T), e.params.dynamicNavbar && ((d = l.find(".navbar-inner").filter(function(e, a) {
                    return 0 === i(a).parents(r.router._modalsSelector).length
                })).length > 0 && (l.prepend(d), r.router._remove(l.find(".navbar").filter(function(e, a) {
                    return 0 === i(a).parents(r.router._modalsSelector).length
                })))), void s()) : void(e.allowPageChange = !0) : (w || (e.url = e.history[e.history.length - 2], h = e.url), f ? (n(), void s()) : x ? (l = i(k).find('.page[data-page="' + x + '"]'), e.params.dynamicNavbar && (0 === (d = i(k).children(".navbar").find('.navbar-inner[data-page="' + x + '"]')).length && l[0].f7RelatedNavbar && (d = i(l[0].f7RelatedNavbar)), 0 === d.length && l[0].f7PageData && (d = i(l[0].f7PageData.navbarInnerContainer))), void s()) : h && h in e.pageElementsCache ? (l = e.pageElementsCache[h].page, d = e.pageElementsCache[h].navbarInner, void s()) : void(e.allowPageChange = !0))
            ...
            r.modalStack = [], r.modalStackClearQueue = function() {
                ...
                if (r.params.modalTemplate) r._compiledTemplates.modal || (r._compiledTemplates.modal = s.compile(r.params.modalTemplate)), a = r._compiledTemplates.modal(e);
                    ...
                    var o = e.title ? '<div class="modal-title">' + e.title + "</div>" : "",
                        ...
                        m = e.verticalButtons ? "modal-buttons-vertical" : "",
                        u = e.buttons && e.buttons.length > 0 ? '<div class="modal-buttons modal-buttons-' + e.buttons.length + " " + m + '">' + t + "</div>" : "";
                    a = '<div class="modal ' + c + " " + (e.cssClass || "") + '"><div class="modal-inner">' + (o + l + p) + "</div>" + u + "</div>"
                }
                d.innerHTML = a;
                var h = i(d).children();
                ...
                var n, o, l, p, c = !1;
                if (1 === arguments.length || 2 === arguments.length && "boolean" == typeof arguments[1] ? (a = arguments[0], t = arguments[1]) : r.device.ios ? r.device.ipad && (c = !0) : r.width >= 768 && (c = !0), void 0 === t && (t = !0), (a = a || []).length > 0 && !Array.isArray(a[0]) && (a = [a]), c) {
                    var m = r.params.modalActionsToPopoverTemplate || '<div class="popover actions-popover"><div class="popover-inner">{{#each this}}<div class="list-block"><ul>{{#each this}}{{#if label}}<li class="actions-popover-label {{#if color}}color-{{color}}{{/if}} {{#if bold}}actions-popover-bold{{/if}}">{{text}}</li>{{else}}<li><a href="#" class="item-link list-button {{#if color}}color-{{color}}{{/if}} {{#if bg}}bg-{{bg}}{{/if}} {{#if bold}}actions-popover-bold{{/if}} {{#if disabled}}disabled{{/if}}">{{text}}</a></li>{{/if}}{{/each}}</ul></div>{{/each}}</div></div>';
                    r._compiledTemplates.actionsToPopover || (r._compiledTemplates.actionsToPopover = s.compile(m));
                    var u = r._compiledTemplates.actionsToPopover(a);
                    n = i(r.popover(u, e, !0, t)), o = ".list-block ul", l = ".list-button"
                } else {
                    if (r.params.modalActionsTemplate) r._compiledTemplates.actions || (r._compiledTemplates.actions = s.compile(r.params.modalActionsTemplate)), p = r._compiledTemplates.actions(a);
                    else {
                        ...
                        p = '<div class="actions-modal">' + h + "</div>"
                    }
                    d.innerHTML = p, n = i(d).children(), r.root.append(n[0]), o = ".actions-modal-group", l = ".actions-modal-button"
                }
                return n.find(o).each(function(e, t) {
                    ...
                    i(t).children().each(function(e, t) {
                        var o, p = e,
                            d = a[s][p];
                        !c && i(t).is(l) && (o = i(t)), c && i(t).find(l).length > 0 && (o = i(t).find(l)), o && o.on("click", function(e) {
                            !1 !== d.close && r.closeModal(n), d.onClick && d.onClick(n, e)
                        })
                    })
                }), c || r.openModal(n, t), n[0]
                ...
                function o() {
                    ...
                    p ? e.removeClass("popover-on-left popover-on-right popover-on-top popover-on-bottom").css({
                        left: "",
                        top: ""
                    }) : (l = (t = e.find(".popover-angle")).width() / 2, t.removeClass("on-left on-right on-top on-bottom").css({
                        left: "",
                        top: ""
                    }));
                    var d = a.outerWidth(),
                ...
                return 0 !== (e = i(e)).length && (0 === e.parents("body").length && (a && e.addClass("remove-on-close"), r.root.append(e[0])), e.show(), r.openModal(e, t), e[0])
            }, r.pickerModal = function(e, a, t) {
                if (void 0 === a && (a = !0), void 0 === t && (t = !0), "string" == typeof e && e.indexOf("<") >= 0) {
                    if (!((e = i(e)).length > 0)) return !1;
                    a && e.addClass("remove-on-close"), r.root.append(e[0])
                }
                return 0 !== (e = i(e)).length && (0 === e.parents("body").length && (a && e.addClass("remove-on-close"), r.root.append(e[0])), i(".picker-modal.modal-in:not(.modal-out)").length > 0 && !e.hasClass("modal-in") && r.closeModal(".picker-modal.modal-in:not(.modal-out)"), e.show(), r.openModal(e, t), e[0])
            }, r.loginScreen = function(e, a) {
                return e || (e = ".login-screen"), void 0 === a && (a = !0), 0 !== (e = i(e)).length && (i(".login-screen.modal-in:not(.modal-out)").length > 0 && !e.hasClass("modal-in") && r.closeModal(".login-screen.modal-in:not(.modal-out)"), e.show(), r.openModal(e, a), e[0])
            }, r.openModal = function(e, a) {
                void 0 === a && (a = !0), (e = i(e))[a ? "removeClass" : "addClass"]("not-animated");
                var t = e.hasClass("modal"),
                    ...
                    d = "modal";
                if (n && (d = "popover"), s && (d = "popup"), o && (d = "loginscreen"), l && (d = "picker"), p && (d = "actions"), i(".modal.modal-in:not(.modal-out)").length && r.params.modalStack && t) r.modalStack.push(function() {
                    r.openModal(e)
                });
                else if (!0 !== e.data("f7-modal-shown")) {
                    e.data("f7-modal-shown", !0);
                    var c, m = e.parent();
                    return r.params.modalsMoveToRoot && !m.is(r.root) && (r.root.append(e), e.once(d + ":closed", function() {
                        m.append(e)
                    })), e.once(d + ":close", function() {
                        e.removeData("f7-modal-shown")
                    }), t && (e.show(), e.css({
                        marginTop: -Math.round(e.outerHeight() / 2) + "px"
                    })), o || l || (0 !== i(".modal-overlay").length || s || r.root.append('<div class="modal-overlay"></div>'), 0 === i(".popup-overlay").length && s && r.root.append('<div class="popup-overlay"></div>'), c = i(s ? ".popup-overlay" : ".modal-overlay")), r.params.material && l && e.hasClass("picker-calendar") && (0 !== i(".picker-modal-overlay").length || s || r.root.append('<div class="picker-modal-overlay"></div>'), c = i(".picker-modal-overlay")), c && c[a ? "removeClass" : "addClass"]("not-animated"), e[0].clientLeft, e.trigger("open " + d + ":open"), l && i("body").addClass("with-picker-modal"), e.find("." + r.params.viewClass).length > 0 && (e.find(".page").each(function() {
                        r.initPageWithCallback(this)
                    }), e.find(".navbar").each(function() {
                        r.initNavbarWithCallback(this)
                    })), o || l || c.addClass("modal-overlay-visible"), r.params.material && l && c && c.addClass("modal-overlay-visible"), a ? e.removeClass("modal-out").addClass("modal-in").transitionEnd(function(a) {
                ...
                var n;
                if (0 !== (e = i(e || r.root)).length && (a && (a = Math.min(Math.max(a, 0), 100)), 0 !== (n = e.hasClass("progressbar") ? e : e.children(".progressbar")).length && !n.hasClass("progressbar-infinite"))) return n[0].clientLeft, n.children("span").transform("translate3d(" + (-100 + a) + "%,0,0)"), void 0 !== t ? n.children("span").transition(t) : n.children("span").transition(""), n[0]
            }, r.showProgressbar = function(e, a, t) {
                var n;
                if ("number" == typeof e && (e = r.root, a = arguments[0], t = arguments[1]), a && "string" == typeof a && parseFloat(a) !== 1 * a && (t = a, a = void 0), 0 !== (e = i(e || r.root)).length) return e.hasClass("progressbar") ? n = e : 0 === (n = e.children(".progressbar:not(.progressbar-out), .progressbar-infinite:not(.progressbar-out)")).length && (n = i(void 0 !== a ? '<span class="progressbar progressbar-in' + (t ? " color-" + t : "") + '"><span></span></span>' : '<span class="progressbar-infinite progressbar-in' + (t ? " color-" + t : "") + '"></span>'), e.append(n)), a && r.setProgressbar(e, a), n[0]
            }, r.hideProgressbar = function(e) {
                var a;
                0 !== (e = i(e || r.root)).length && (0 !== (a = e.hasClass("progressbar") ? e : e.children(".progressbar, .progressbar-infinite")).length && a.hasClass("progressbar-in") && !a.hasClass("progressbar-out") && a.removeClass("progressbar-in").addClass("progressbar-out").animationEnd(function() {
                    a.remove(), a = null
                }))
            }, r.initPageProgressbar = function(e) {
                (e = i(e)).find(".progressbar").each(function() {
                    var e = i(this);
                ...
                var t = i(".panel-" + e);
                if (0 === t.length || t.hasClass("active") || t.hasClass("panel-visible-by-breakpoint")) return !1;
                r.closePanel(), r.allowPanelOpen = !1;
                var n = t.hasClass("panel-reveal") ? "reveal" : "cover";
                t[a ? "removeClass" : "addClass"]("not-animated"), t.css({
                    display: "block"
                }).addClass("active"), t.trigger("open panel:open");
                var s = i(".panel-overlay");
                s[a ? "removeClass" : "addClass"]("not-animated"), s.show(), t.find("." + r.params.viewClass).length > 0 && r.sizeNavbars && r.sizeNavbars(t.find("." + r.params.viewClass)[0]);
                var o = (t[0].clientLeft, "reveal" === n ? i("." + r.params.viewsClass) : t);
                return a ? function e() {
                    o.transitionEnd(function(a) {
                        i(a.target).is(o) ? (t.hasClass("active") ? t.trigger("opened panel:opened") : t.trigger("closed panel:closed"), s.css({
                            display: ""
                        }), r.allowPanelOpen = !0) : e()
                    })
                }() : (t.trigger("opened panel:opened"), s.css({
                    display: ""
                }), r.allowPanelOpen = !0), i("body").addClass("with-panel-" + e + "-" + n), !0
                ...
                if (r.params.swipePanel) {
                    if (e = i(".panel.panel-" + r.params.swipePanel), a = r.params.swipePanel, 0 === e.length && "both" !== a) return
                } else {
                    if (!r.params.swipePanelOnlyClose) return;
                    if (0 === i(".panel").length) return
                }
                var t, n, s, o, l, p, d, c, m, u, h, f = i(".panel-overlay"),
                    g = {},
                    v = i("." + r.params.viewsClass),
                    b = !("touchstart" !== r.touchEvents.start || !r.support.passiveListener) && {
                        passive: !0,
                        capture: !1
                    },
                    w = !!r.support.passiveListener && {
                        passive: !1,
                        capture: !1
                    };
                i(document).on(r.touchEvents.start, function(l) {
                    if (r.allowPanelOpen && (r.params.swipePanel || r.params.swipePanelOnlyClose) && !t && !(i(".modal-in, .photo-browser-in").length > 0) && (r.params.swipePanelCloseOpposite || r.params.swipePanelOnlyClose || !(i(".panel.active").length > 0) || e.hasClass("active")) && !(l.target && "input" === l.target.nodeName.toLowerCase() && "range" === l.target.type || i(l.target).closest(".tabs-swipeable-wrap").length > 0)) {
                        if (g.x = "touchstart" === l.type ? l.targetTouches[0].pageX : l.pageX, g.y = "touchstart" === l.type ? l.targetTouches[0].pageY : l.pageY, r.params.swipePanelCloseOpposite || r.params.swipePanelOnlyClose) {
                            if (i(".panel.active").length > 0) a = i(".panel.active").hasClass("panel-left") ? "left" : "right";
                            else {
                                if (r.params.swipePanelOnlyClose) return;
                                a = r.params.swipePanel
                            }
                            if (!a) return
                        }
                        if (e = i(".panel.panel-" + a), c = e.hasClass("active"), r.params.swipePanelActiveArea && !c) {
                            if ("left" === a && g.x > r.params.swipePanelActiveArea) return;
                            if ("right" === a && g.x < r.width - r.params.swipePanelActiveArea) return
                        }
                        n = !1, t = !0, s = void 0, o = (new Date).getTime(), h = void 0
                    }
                }, b), i(document).on(r.touchEvents.move, function(b) {
                    if (t && !b.f7PreventPanelSwipe) {
                        var w = "touchmove" === b.type ? b.targetTouches[0].pageX : b.pageX,
                            C = "touchmove" === b.type ? b.targetTouches[0].pageY : b.pageY;
                        if (void 0 === s && (s = !!(s || Math.abs(C - g.y) > Math.abs(w - g.x))), s) return void(t = !1);
                        if (!h) {
                            if (h = w > g.x ? "to-right" : "to-left", "both" === a) {
                                if (a = i(".panel.active").length > 0 ? i(".panel.active").hasClass("panel-left") ? "left" : "right" : "to-right" === h ? "left" : "right", r.params.swipePanelActiveArea > 0) {
                                    if ("left" === a && g.x > r.params.swipePanelActiveArea) return void(t = !1);
                                    if ("right" === a && g.x < r.width - r.params.swipePanelActiveArea) return void(t = !1)
                                }
                                e = i(".panel.panel-" + a)
                            }
                            if (e.hasClass("panel-visible-by-breakpoint")) return void(t = !1);
                            if ("left" === a && "to-left" === h && !e.hasClass("active") || "right" === a && "to-right" === h && !e.hasClass("active")) return void(t = !1)
                        }
                        if (r.params.swipePanelNoFollow) return (new Date).getTime() - o < 300 && ("to-left" === h && ("right" === a && r.openPanel(a), "left" === a && e.hasClass("active") && r.closePanel()), "to-right" === h && ("left" === a && r.openPanel(a), "right" === a && e.hasClass("active") && r.closePanel())), t = !1, void(n = !1);
                        n || (u = e.hasClass("panel-cover") ? "cover" : "reveal", c || (e.show(), f.show()), m = e[0].offsetWidth, e.transition(0), e.find("." + r.params.viewClass).length > 0 && r.sizeNavbars && r.sizeNavbars(e.find("." + r.params.viewClass)[0])), n = !0, b.preventDefault();
                        var y = c ? 0 : -r.params.swipePanelThreshold;
                        "right" === a && (y = -y), l = w - g.x + y, "right" === a ? "cover" === u ? ((p = l + (c ? 0 : m)) < 0 && (p = 0), p > m && (p = m)) : ((p = l - (c ? m : 0)) > 0 && (p = 0), p < -m && (p = -m)) : ((p = l + (c ? m : 0)) < 0 && (p = 0), p > m && (p = m)), "reveal" === u ? (v.transform("translate3d(" + p + "px,0,0)").transition(0), f.transform("translate3d(" + p + "px,0,0)").transition(0), e.trigger("panel:swipe", {
                            progress: Math.abs(p / m)
                        }), r.pluginHook("swipePanelSetTransform", v[0], e[0], Math.abs(p / m))) : ("left" === a && (p -= m), e.transform("translate3d(" + p + "px,0,0)").transition(0), f.transition(0), d = 1 - Math.abs(p / m), f.css({
                            opacity: d
                        }), e.trigger("panel:swipe", {
                            progress: Math.abs(p / m)
                        }), r.pluginHook("swipePanelSetTransform", v[0], e[0], Math.abs(p / m)))
                    }
                }, w), i(document).on(r.touchEvents.end, function(s) {
                    if (!t || !n) return t = !1, void(n = !1);
                    t = !1, n = !1;
                    var l, d = (new Date).getTime() - o,
                        h = 0 === p || Math.abs(p) === m;
                    if ("swap" == (l = c ? "cover" === u ? 0 === p ? "reset" : d < 300 && Math.abs(p) > 0 ? "swap" : d >= 300 && Math.abs(p) < m / 2 ? "reset" : "swap" : p === -m ? "reset" : d < 300 && Math.abs(p) >= 0 || d >= 300 && Math.abs(p) <= m / 2 ? "left" === a && p === m ? "reset" : "swap" : "reset" : "cover" === u ? 0 === p ? "swap" : d < 300 && Math.abs(p) > 0 ? "swap" : d >= 300 && Math.abs(p) < m / 2 ? "swap" : "reset" : 0 === p ? "reset" : d < 300 && Math.abs(p) > 0 || d >= 300 && Math.abs(p) >= m / 2 ? "swap" : "reset") && (r.allowPanelOpen = !0, c ? (r.closePanel(), h && (e.css({
                            display: ""
                        }), i("body").removeClass("panel-closing"))) : r.openPanel(a), h && (r.allowPanelOpen = !0)), "reset" === l)
                        if (c) r.allowPanelOpen = !0, r.openPanel(a);
                        else if (r.closePanel(), h) r.allowPanelOpen = !0, e.css({
                        display: ""
                    });
                    else {
                        var g = "reveal" === u ? v : e;
                        e.trigger("close panel:close"), i("body").addClass("panel-closing"), g.transitionEnd(function() {
                            e.hasClass("active") || (e.trigger("close panel:closed"), e.css({
                                display: ""
                            }), i("body").removeClass("panel-closing"), r.allowPanelOpen = !0)
                        })
                    }
                    "reveal" === u && (v.transition(""), v.transform("")), e.transition("").transform(""), f.css({
                        display: ""
                    }).transform("").transition("").css("opacity", "")
                }, b)
            }, r.initImagesLazyLoad = function(e) {
                function a() {
                    (s = e.find(".lazy")).each(function(e, a) {
                        var t, n, s;
                        (a = i(a)).parents(".tab:not(.active)").length > 0 || (t = a[0], n = t.getBoundingClientRect(), s = r.params.imagesLazyLoadThreshold || 0, n.top >= 0 - s && n.left >= 0 - s && n.top <= r.height + s && n.left <= r.width + s && function e(a) {
                            var t = (a = i(a)).attr("data-background"),
                                n = t || a.attr("data-src");
                            if (n) {
                                if (r.params.imagesLazyLoadSequential && d) return void(p.indexOf(a[0]) < 0 && p.push(a[0]));
                                d = !0;
                                var s = new Image;
                                s.onload = function() {
                                    a.removeClass("lazy").addClass("lazy-loaded"), t ? a.css("background-image", "url(" + n + ")") : a.attr("src", n), r.params.imagesLazyLoadSequential && (d = !1, p.length > 0 && e(p.shift())), a.trigger("lazy-loaded"), r.params.onLazyLoaded && r.params.onLazyLoaded(a)
                                }, s.onerror = function() {
                                    a.removeClass("lazy").addClass("lazy-loaded"), t ? a.css("background-image", "url(" + l + ")") : a.attr("src", l), r.params.imagesLazyLoadSequential && (d = !1, p.length > 0 && e(p.shift())), a.trigger("lazy-error"), r.params.onLazyError && r.params.onLazyError(a)
                                }, s.src = n, a.trigger("lazy-load"), r.params.onLazyLoad && !a.hasClass("lazy-loaded") && r.params.onLazyLoad(a)
                            }
                        }(a))
                    })
                }
                ...
                function t(t) {
                    var n = t ? "off" : "on";
                    s[n]("lazy", a), s.parents(".tab")[n]("show", a), e[n]("lazy", a), o[n]("lazy", a), o[n]("scroll", a), r["on" === n ? "onResize" : "offResize"](a)
                }
                ...
                var s, o;
                if (((e = i(e)).hasClass("lazy") ? e = (s = e).parents(".page") : s = e.find(".lazy"), 0 !== s.length) && (e.hasClass("page-content") ? (o = e, e = e.parents(".page")) : o = e.find(".page-content"), 0 !== o.length)) {
                    var l = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAA1BMVEXCwsK592mkAAAACklEQVQI12NgAAAAAgAB4iG8MwAAAABJRU5ErkJggg==";
                    "string" == typeof r.params.imagesLazyLoadPlaceholder && (l = r.params.imagesLazyLoadPlaceholder), !1 !== r.params.imagesLazyLoadPlaceholder && s.each(function() {
                        i(this).attr("data-src") && !i(this).attr("src") && i(this).attr("src", l)
                    });
                    var p = [],
                        d = !1;
                    e[0].f7DestroyImagesLazyLoad = n, t(), e.hasClass("page") && e.once("page:beforeremove", n), a(), e.once("page:afteranimation", a)
                }
            }, r.destroyImagesLazyLoad = function(e) {
                (e = i(e)).length > 0 && e[0].f7DestroyImagesLazyLoad && e[0].f7DestroyImagesLazyLoad()
            }, r.reinitImagesLazyLoad = function(e) {
                (e = i(e)).length > 0 && e.trigger("lazy")
            ...
            r.messages = function(e, a) {
                return new function(e, a) {
                    ...
                    if (n.params = a, n.container = i(e), 0 !== n.container.length) return n.params.autoLayout && n.container.addClass("messages-auto-layout"), n.params.newMessagesFirst && n.container.addClass("messages-new-first"), n.pageContainer = n.container.parents(".page").eq(0), n.pageContent = n.pageContainer.find(".page-content"), n.template = Template7.compile(n.params.messageTemplate), n.layout = function() {
                        ...
                        return 0 !== (e = i(e)).length && (e.remove(), n.params.autoLayout && n.layout(), !0)
                ...
                var a = (e = i(e)).find(".messages");
                if (0 !== a.length && a.hasClass("messages-init")) {
                    var t = r.messages(a, a.dataset());
                    e.hasClass("page") && e.on("page:beforeremove", function a() {
                        t.destroy(), e.off("page:beforeremove", a)
                    })
                }
                ...
                function a(e) {
                    r.allowSwipeout && (o = !1, s = !0, l = void 0, M.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, M.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, p = (new Date).getTime())
                }

                function t(e) {
                    if (s) {
                        var a, t, n, p, I = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
                            E = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
                        if (void 0 === l && (l = !!(l || Math.abs(E - M.y) > Math.abs(I - M.x))), l) return void(s = !1);
                        if (!o) {
                            if (i(".list-block.sortable-opened").length > 0) return;
                            c = i(this), m = c.find(".swipeout-content"), u = c.find(".swipeout-actions-right"), h = c.find(".swipeout-actions-left"), f = g = C = y = k = T = null, h.hasClass("swipeout-actions-no-fold") || r.params.swipeoutActionsNoFold, u.hasClass("swipeout-actions-no-fold") || r.params.swipeoutActionsNoFold, h.length > 0 && (f = h.outerWidth(), C = h.children("a"), T = h.find(".swipeout-overswipe")), u.length > 0 && (g = u.outerWidth(), y = u.children("a"), k = u.find(".swipeout-overswipe")), (b = c.hasClass("swipeout-opened")) && (w = c.find(".swipeout-actions-left.swipeout-actions-opened").length > 0 ? "left" : "right"), c.removeClass("transitioning"), r.params.swipeoutNoFollow || (c.find(".swipeout-actions-opened").removeClass("swipeout-actions-opened"), c.removeClass("swipeout-opened"))
                        }
                        if (o = !0, e.preventDefault(), d = I - M.x, v = d, b && ("right" === w ? v -= g : v += f), v > 0 && 0 === h.length || v < 0 && 0 === u.length) {
                            if (!b) return s = o = !1, m.transform(""), y && y.length > 0 && y.transform(""), void(C && C.length > 0 && C.transform(""));
                            v = 0
                        }
                        if (v < 0 ? x = "to-left" : v > 0 ? x = "to-right" : x || (x = "to-left"), e.f7PreventPanelSwipe = !0, r.params.swipeoutNoFollow) return b ? ("right" === w && d > 0 && r.swipeoutClose(c), "left" === w && d < 0 && r.swipeoutClose(c)) : (d < 0 && u.length > 0 && r.swipeoutOpen(c, "right"), d > 0 && h.length > 0 && r.swipeoutOpen(c, "left")), s = !1, void(o = !1);
                        if (P = !1, S = !1, u.length > 0)
                            for (n = v / g, v < -g && (v = -g - Math.pow(-v - g, .8), k.length > 0 && (S = !0)), a = 0; a < y.length; a++) void 0 === y[a]._buttonOffset && (y[a]._buttonOffset = y[a].offsetLeft), t = y[a]._buttonOffset, p = i(y[a]), k.length > 0 && p.hasClass("swipeout-overswipe") && (p.css({
                                left: (S ? -t : 0) + "px"
                            }), S ? p.addClass("swipeout-overswipe-active") : p.removeClass("swipeout-overswipe-active")), p.transform("translate3d(" + (v - t * (1 + Math.max(n, -1))) + "px,0,0)");
                        if (h.length > 0)
                            for (n = v / f, v > f && (v = f + Math.pow(v - f, .8), T.length > 0 && (P = !0)), a = 0; a < C.length; a++) void 0 === C[a]._buttonOffset && (C[a]._buttonOffset = f - C[a].offsetLeft - C[a].offsetWidth), t = C[a]._buttonOffset, p = i(C[a]), T.length > 0 && p.hasClass("swipeout-overswipe") && (p.css({
                                left: (P ? t : 0) + "px"
                            }), P ? p.addClass("swipeout-overswipe-active") : p.removeClass("swipeout-overswipe-active")), C.length > 1 && p.css("z-index", C.length - a), p.transform("translate3d(" + (v + t * (1 - Math.min(n, 1))) + "px,0,0)");
                ...
                function n(e) {
                    ...
                    if (n = "to-left" === x ? u : h, t = "to-left" === x ? g : f, a = k < 300 && (d < -10 && "to-left" === x || d > 10 && "to-right" === x) || k >= 300 && Math.abs(v) > t / 2 ? "open" : "close", k < 300 && (0 === Math.abs(v) && (a = "close"), Math.abs(v) === t && (a = "open")), "open" === a) {
                        r.swipeoutOpenedEl = c, c.trigger("open swipeout:open"), c.addClass("swipeout-opened transitioning");
                        var M = "to-left" === x ? -t : t;
                        if (m.transform("translate3d(" + M + "px,0,0)"), n.addClass("swipeout-actions-opened"), l = "to-left" === x ? y : C)
                            for (w = 0; w < l.length; w++) i(l[w]).transform("translate3d(" + M + "px,0,0)");
                    ...
                    if (C && C.length > 0 && C !== l)
                        for (w = 0; w < C.length; w++) T = C[w]._buttonOffset, void 0 === T && (C[w]._buttonOffset = f - C[w].offsetLeft - C[w].offsetWidth), i(C[w]).transform("translate3d(" + T + "px,0,0)");
                    if (y && y.length > 0 && y !== l)
                        for (w = 0; w < y.length; w++) T = y[w]._buttonOffset, void 0 === T && (y[w]._buttonOffset = y[w].offsetLeft), i(y[w]).transform("translate3d(" + -T + "px,0,0)");
                ...
                var s, o, l, p, d, c, m, u, h, f, g, v, b, w, C, y, x, T, k, P, S, M = {},
                    I = !!r.support.passiveListener && {
                        passive: !1,
                        capture: !1
                    };
                ...
                }, I), e ? (i(e).on(r.touchEvents.start, a, I), i(e).on(r.touchEvents.move, t, I), i(e).on(r.touchEvents.end, n, I)) : (i(document).on(r.touchEvents.start, ".list-block li.swipeout", a, I), i(document).on(r.touchEvents.move, ".list-block li.swipeout", t, I), i(document).on(r.touchEvents.end, ".list-block li.swipeout", n, I))
                ...
                function t() {
                    r.allowSwipeout = !0, e.hasClass("swipeout-opened") || (e.removeClass("transitioning"), l.transform(""), e.trigger("closed swipeout:closed"), a && a.call(e[0]), n && clearTimeout(n))
                }
                if (0 !== (e = i(e)).length && e.hasClass("swipeout-opened")) {
                    var n, s = e.find(".swipeout-actions-opened").hasClass("swipeout-actions-right") ? "right" : "left",
                        o = e.find(".swipeout-actions-opened").removeClass("swipeout-actions-opened"),
                        l = o.children("a"),
                        p = o.outerWidth();
                    r.allowSwipeout = !1, e.trigger("close swipeout:close"), e.removeClass("swipeout-opened").addClass("transitioning"), e.find(".swipeout-content").transform("").transitionEnd(t), n = setTimeout(t, 500);
                    for (var d = 0; d < l.length; d++) "right" === s ? i(l[d]).transform("translate3d(" + -l[d].offsetLeft + "px,0,0)") : i(l[d]).transform("translate3d(" + (p - l[d].offsetWidth - l[d].offsetLeft) + "px,0,0)"), i(l[d]).css({
                        left: "0px"
                ...
                0 !== (e = i(e)).length && (e.length > 1 && (e = i(e[0])), r.swipeoutOpenedEl = void 0, e.trigger("delete swipeout:delete"), e.css({
                ...
                return 0 === (e = i(e)).length && (e = i(".list-block.sortable")), e.toggleClass("sortable-opened"), e.hasClass("sortable-opened") ? e.trigger("open sortable:open") : e.trigger("close sortable:close"), e
            }, r.sortableOpen = function(e) {
                return 0 === (e = i(e)).length && (e = i(".list-block.sortable")), e.addClass("sortable-opened"), e.trigger("open sortable:open"), e
            }, r.sortableClose = function(e) {
                return 0 === (e = i(e)).length && (e = i(".list-block.sortable")), e.removeClass("sortable-opened"), e.trigger("close sortable:close"), e
                ...
                function e(e) {
                    if (t && o) {
                        ...
                        n || (o.addClass("sorting"), h.addClass("sortable-sorting"), d = o[0].offsetTop, c = o.parent().height() - o[0].offsetTop - o.height(), l = o[0].offsetHeight), n = !0, e.preventDefault(), e.f7PreventPanelSwipe = !0;
                        var r = a - s;
                        r < -d && (r = -d), r > c && (r = c), o.transform("translate3d(0," + r + "px,0)"), u = m = void 0, p.each(function() {
                            var e = i(this);
                            if (e[0] !== o[0]) {
                                var a = e[0].offsetTop,
                                    t = e.height(),
                                    n = o[0].offsetTop + r;
                                n >= a - t / 2 && o.index() < e.index() ? (e.transform("translate3d(0, " + -l + "px,0)"), m = e, u = void 0) : n <= a + t / 2 && o.index() > e.index() ? (e.transform("translate3d(0, " + l + "px,0)"), m = void 0, u || (u = e)) : i(this).transform("translate3d(0, 0%,0)")
                            }
                        })
                    }
                }
                ...
                function a(e) {
                    if (r.allowPanelOpen = r.allowSwipeout = !0, !t || !n) return t = !1, void(n = !1);
                    var a, i, s;
                    e.preventDefault(), p.transform(""), o.removeClass("sorting"), h.removeClass("sortable-sorting"), m && (o.insertAfter(m), o.trigger("sort sortable:sort", {
                        startIndex: f,
                        newIndex: o.index()
                    })), u && (o.insertBefore(u), o.trigger("sort sortable:sort", {
                        startIndex: f,
                        newIndex: o.index()
                    })), (m || u) && h.hasClass("virtual-list") && (a = h[0].f7VirtualList, i = o[0].f7VirtualListIndex, s = u ? u[0].f7VirtualListIndex : m[0].f7VirtualListIndex, a && a.moveItem(i, s)), m = u = void 0, t = !1, n = !1
                }
                var t, n, s, o, l, p, d, c, m, u, h, f, g = !!r.support.passiveListener && {
                    passive: !1,
                    capture: !1
                };
                i(document).on(r.touchEvents.start, ".list-block.sortable .sortable-handler", function(e) {
                    n = !1, t = !0, s = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, o = i(this).parent(), f = o.index(), p = o.parent().children("li"), h = o.parents(".sortable"), e.preventDefault(), r.allowPanelOpen = r.allowSwipeout = !1
                }, g), r.support.touch ? (i(document).on(r.touchEvents.move, ".list-block.sortable .sortable-handler", e, g), i(document).on(r.touchEvents.end, ".list-block.sortable .sortable-handler", a, g)) : (i(document).on(r.touchEvents.move, e, g), i(document).on(r.touchEvents.end, a, g))
            }, r.initSmartSelects = function(e) {
                var a;
                0 !== (a = (e = i(e)).is(".smart-select") ? e : e.find(".smart-select")).length && a.each(function() {
                    var e = i(this),
                        a = e.find("select");
                    if (0 !== a.length) {
                        var t = a[0];
                ...
                var n = (e = i(e)).parents(".smart-select");
                ...
                function n(e) {
                    x.selectedOptions.length >= Y ? e.find('input[type="checkbox"]').each(function() {
                ...
                function o(a) {
                    if (a = i(a), b) {
                        ...
                        a.once("popup" === p || "picker" === p ? "closed" : "pageBeforeRemove", function() {
                            t && t.destroy && t.destroy()
                        })
                    }
                    Y && n(a), h && a.find('input[type="radio"][name="' + V + '"]:checked').parents("label").once("click", function() {
                        "popup" === p ? r.closeModal(te) : "picker" === p ? r.closeModal(re) : l.router.back()
                    }), a.on("change", 'input[name="' + V + '"]', function() {
                        var t, s, o, d = this.value,
                            c = [];
                        if ("checkbox" === this.type) {
                            for (var m = 0; m < x.options.length; m++) t = x.options[m], t.value === d && (t.selected = this.checked), t.selected && (o = t.dataset ? t.dataset.displayAs : i(t).data("display-as"), s = o && void 0 !== o ? o : t.textContent, c.push(s.trim()));
                            Y && n(a)
                        } else t = e.find('option[value="' + d + '"]')[0], o = t.dataset ? t.dataset.displayAs : i(t).data("display-as"), s = o && void 0 !== o ? o : t.textContent, c = [s], x.value = d;
                        T.trigger("change"), e.find(".item-after").text(c.join(", ")), h && "radio" === R && ("popup" === p ? r.closeModal(te) : "picker" === p ? r.closeModal(re) : l.router.back())
                    })
                }
                if (0 !== (e = i(e)).length) {
                    var l = e.parents("." + r.params.viewClass);
                    if (0 !== l.length) {
                        l = l[0].f7View;
                        var p = e.attr("data-open-in") || r.params.smartSelectOpenIn;
                        if ("popup" === p) {
                        ...
                        var d, c = e.dataset(),
                            m = c.pageTitle || e.find(".item-title").text(),
                            u = c.backText || r.params.smartSelectBackText;
                        d = "picker" === p ? c.pickerCloseText || c.backText || r.params.smartSelectPickerCloseText : c.popupCloseText || c.backText || r.params.smartSelectPopupCloseText;
                        var h = void 0 !== c.backOnSelect ? c.backOnSelect : r.params.smartSelectBackOnSelect,
                            f = c.formTheme || r.params.smartSelectFormTheme,
                            g = c.navbarTheme || r.params.smartSelectNavbarTheme,
                            v = c.toolbarTheme || r.params.smartSelectToolbarTheme,
                            b = c.virtualList,
                            w = c.virtualListHeight,
                            C = r.params.material,
                            y = c.pickerHeight || r.params.smartSelectPickerHeight,
                            x = e.find("select")[0],
                            T = i(x),
                            k = T.dataset();
                        if (!(x.disabled || e.hasClass("disabled") || T.hasClass("disabled"))) {
                            for (var P, S, M, I, E, O, L, D, z, B, N, A = [], H = (new Date).getTime(), R = x.multiple ? "checkbox" : "radio", V = R + "-" + H, Y = T.attr("maxlength"), q = x.name, F = 0; F < x.length; F++) P = i(x[F]), N = P.dataset(), M = N.optionImage || k.optionImage || c.optionImage, I = N.optionIcon || k.optionIcon || c.optionIcon, S = M || I || "checkbox" === R, C && (S = M || I), z = N.optionColor, B = N.optionClass, P[0].disabled && (B += " disabled"), E = P.parent("optgroup")[0], O = E && E.label, L = !1, E && E !== D && (L = !0, D = E, A.push({
                                groupLabel: O,
                                isLabel: L
                            })), A.push({
                                value: P[0].value,
                                text: P[0].textContent.trim(),
                            ...
                            var W = r._compiledTemplates.smartSelectItem,
                                X = "";
                            if (!b)
                                for (var G = 0; G < A.length; G++) X += W(A[G]);
                            var j, _, U = "",
                                J = "",
                                Q = "",
                                K = "";
                            "picker" === p ? (r._compiledTemplates.smartSelectToolbar || (r._compiledTemplates.smartSelectToolbar = s.compile(r.params.smartSelectToolbarTemplate || '<div class="toolbar {{#if toolbarTheme}}theme-{{toolbarTheme}}{{/if}}"><div class="toolbar-inner"><div class="left"></div><div class="right"><a href="#" class="link close-picker"><span>{{closeText}}</span></a></div></div></div>')), U = r._compiledTemplates.smartSelectToolbar({
                                pageTitle: m,
                                closeText: d,
                                openIn: p,
                                toolbarTheme: v,
                                inPicker: "picker" === p
                            })) : (r._compiledTemplates.smartSelectNavbar || (r._compiledTemplates.smartSelectNavbar = s.compile(r.params.smartSelectNavbarTemplate || '<div class="navbar {{#if navbarTheme}}theme-{{navbarTheme}}{{/if}}"><div class="navbar-inner">{{leftTemplate}}<div class="center sliding">{{pageTitle}}</div></div></div>')), j = r._compiledTemplates.smartSelectNavbar({
                                pageTitle: m,
                                backText: u,
                                closeText: d,
                                openIn: p,
                                ...
                                inPopup: "popup" === p,
                                inPage: "page" === p,
                                leftTemplate: "popup" === p ? (r.params.smartSelectPopupCloseTemplate || (C ? '<div class="left"><a href="#" class="link close-popup icon-only"><i class="icon icon-back"></i></a></div>' : '<div class="left"><a href="#" class="link close-popup"><i class="icon icon-back"></i><span>{{closeText}}</span></a></div>')).replace(/{{closeText}}/g, d) : (r.params.smartSelectBackTemplate || (C ? '<div class="left"><a href="#" class="back link icon-only"><i class="icon icon-back"></i></a></div>' : '<div class="left sliding"><a href="#" class="back link"><i class="icon icon-back"></i><span>{{backText}}</span></a></div>')).replace(/{{backText}}/g, u)
                            }), "page" === p ? (_ = "static", e.parents(".navbar-through").length > 0 && (_ = "through"), e.parents(".navbar-fixed").length > 0 && (_ = "fixed"), Q = e.parents(".page").hasClass("no-toolbar") ? "no-toolbar" : "", J = e.parents(".page").hasClass("no-navbar") ? "no-navbar" : "navbar-" + _, K = e.parents(".page").hasClass("no-tabbar") ? "no-tabbar" : "") : _ = "fixed");
                            var Z, $, ee = "smart-select-" + V,
                                ae = void 0 === e.data("searchbar") ? r.params.smartSelectSearchbar : "true" === e.data("searchbar");
                            ae && (Z = e.data("searchbar-placeholder") || "Search", $ = e.data("searchbar-cancel") || "Cancel");
                            var te, re, ne = ("picker" !== p && "through" === _ ? j : "") + '<div class="pages">  <div data-page="' + ee + '" data-select-name="' + q + '" class="page smart-select-page ' + J + " " + Q + " " + K + '">' + ("picker" !== p && "fixed" === _ ? j : "") + (ae ? '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + H + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + Z + '"><a href="#" class="searchbar-clear"></a></div>' + (C ? "" : '<a href="#" class="searchbar-cancel">' + $ + "</a>") + '</form><div class="searchbar-overlay"></div>' : "") + '    <div class="page-content">' + ("picker" !== p && "static" === _ ? j : "") + '      <div class="list-block ' + (b ? "virtual-list" : "") + " smart-select-list-" + H + " " + (f ? "theme-" + f : "") + '">        <ul>' + (b ? "" : X) + "        </ul>      </div>    </div>  </div></div>";
                            "popup" === p ? (a ? (te = i(".popup.smart-select-popup .view")).html(ne) : (te = r.popup('<div class="popup smart-select-popup smart-select-popup-' + V + '"><div class="view navbar-fixed">' + ne + "</div></div>"), te = i(te)), r.initPage(te.find(".page")), o(te)) : "picker" === p ? (a ? (re = i(".picker-modal.smart-select-picker .view")).html(ne) : (re = r.pickerModal('<div class="picker-modal smart-select-picker smart-select-picker-' + V + '"' + (y ? ' style="height:' + y + '"' : "") + ">" + U + '<div class="picker-modal-inner"><div class="view">' + ne + "</div></div></div>"), re = i(re), function() {
                                var a = e.parents(".page-content");
                                if (0 !== a.length) {
                                    var t, r = parseInt(a.css("padding-top"), 10),
                                        n = parseInt(a.css("padding-bottom"), 10),
                                        i = a[0].offsetHeight - r - re.height(),
                                        s = a[0].scrollHeight - r - re.height(),
                                        o = e.offset().top - r + e[0].offsetHeight;
                                    if (o > i) {
                                        var l = a.scrollTop() + o - i;
                                        l + i > s && (t = l + i - s + n, i === s && (t = re.height()), a.css({
                                            "padding-bottom": t + "px"
                                        })), a.scrollTop(l, 300)
                                    }
                                }
                            }(), i("html").on("click", t), re.once("picker:close", function() {
                                e[0].f7SmartSelectPicker = void 0, i("html").off("click", t), e.parents(".page-content").css({
                                    paddingBottom: ""
                                })
                            }), e[0].f7SmartSelectPicker = re[0]), r.initPage(re.find(".page")), o(re)) : (i(document).once("page:init", ".smart-select-page", function(e) {
                                var a = e.detail.page;
                                a.name === ee && o(a.container)
                            }), l.router.load({
                                content: ne,
                                reload: !!a || void 0
                            }))
            ...
            r.virtualList = function(e, a) {
                return new function(e, a) {
                    ...
                    var o, l = this;
                    l.listBlock = i(e), l.params = a, l.items = l.params.items, l.params.showFilteredItemsOnly && (l.filteredItems = []), l.params.template && !l.params.renderItem && ("string" == typeof l.params.template ? l.template = s.compile(l.params.template) : "function" == typeof l.params.template && (l.template = l.params.template)), l.pageContent = l.listBlock.parents(".page-content"), void 0 !== l.params.updatableScroll ? o = l.params.updatableScroll : (o = !0, r.device.ios && r.device.osVersion.split(".")[0] < 8 && (o = !1), l.params.updatableScroll = o), l.ul = l.params.ul ? i(l.params.ul) : l.listBlock.children("ul"), 0 === l.ul.length && (l.listBlock.append("<ul></ul>"), l.ul = l.listBlock.children("ul")), l.domCache = {}, l.displayDomCache = {}, l.tempDomElement = document.createElement("ul"), l.lastRepaintY = null, l.fragment = document.createDocumentFragment(), l.filterItems = function(e, a) {
                        l.filteredItems = [];
                        for (var t = (e[0], e[e.length - 1], 0); t < e.length; t++) l.filteredItems.push(l.items[e[t]]);
                        void 0 === a && (a = !0), a && (l.pageContent[0].scrollTop = 0), l.update()
                    }, l.resetFilter = function() {
                        l.params.showFilteredItemsOnly ? l.filteredItems = [] : (l.filteredItems = null, delete l.filteredItems), l.update()
                    };
                    var p, d, c, m, u, h, f = 0,
                        g = "function" == typeof l.params.height;
                    return l.setListSize = function() {
                        var e = l.filteredItems || l.items;
                        if (p = l.pageContent[0].offsetHeight, g) {
                            h = 0, l.heights = [];
                            for (var a = 0; a < e.length; a++) {
                                var t = l.params.height(e[a]);
                                h += t, l.heights.push(t)
                            }
                        } else h = Math.ceil(e.length / l.params.cols) * l.params.height, d = Math.ceil(p / l.params.height), c = l.params.rowsBefore || 2 * d, m = l.params.rowsAfter || d, u = d + c + m, f = c / 2 * l.params.height;
                        o && l.ul.css({
                            height: h + "px"
                        })
                    }, l.render = function(e, a) {
                        e && (l.lastRepaintY = null);
                        var t = -(l.listBlock[0].getBoundingClientRect().top - l.pageContent[0].getBoundingClientRect().top);
                        if (void 0 !== a && (t = a), null === l.lastRepaintY || Math.abs(t - l.lastRepaintY) > f || !o && l.pageContent[0].scrollTop + p >= l.pageContent[0].scrollHeight) {
                            l.lastRepaintY = t;
                            var r, n, i = l.filteredItems || l.items,
                                s = 0,
                                d = 0;
                            if (g) {
                                var m, v, b = 0;
                                for (f = p, m = 0; m < l.heights.length; m++) v = l.heights[m], void 0 === r && (b + v >= t - 2 * p * l.params.dynamicHeightBufferSize ? r = m : s += v), void 0 === n && ((b + v >= t + 2 * p * l.params.dynamicHeightBufferSize || m === l.heights.length - 1) && (n = m + 1), d += v), b += v;
                                n = Math.min(n, i.length)
                            } else r = (parseInt(t / l.params.height) - c) * l.params.cols, r < 0 && (r = 0), n = Math.min(r + u * l.params.cols, i.length);
                            var w, C = [];
                            l.reachEnd = !1;
                            for (var y = r; y < n; y++) {
                                var x, T;
                                T = l.items.indexOf(i[y]), y === r && (l.currentFromIndex = T), y === n - 1 && (l.currentToIndex = T), l.filteredItems ? l.items[T] === l.filteredItems[l.filteredItems.length - 1] && (l.reachEnd = !0) : T === l.items.length - 1 && (l.reachEnd = !0), l.params.renderExternal ? C.push(i[y]) : l.domCache[T] ? (x = l.domCache[T]).f7VirtualListIndex = T : (l.template && !l.params.renderItem ? l.tempDomElement.innerHTML = l.template(i[y], {
                                    index: T
                                }).trim() : l.params.renderItem ? l.tempDomElement.innerHTML = l.params.renderItem(T, i[y]).trim() : l.tempDomElement.innerHTML = i[y].toString().trim(), x = l.tempDomElement.childNodes[0], l.params.cache && (l.domCache[T] = x), x.f7VirtualListIndex = T), y === r && (w = g ? s : y * l.params.height / l.params.cols), l.params.renderExternal || (x.style.top = w + "px", l.params.onItemBeforeInsert && l.params.onItemBeforeInsert(l, x), l.fragment.appendChild(x))
                            }
                            o || (l.ul[0].style.height = g ? d + "px" : y * l.params.height / l.params.cols + "px"), l.params.renderExternal ? i && 0 === i.length && (l.reachEnd = !0) : (l.params.onBeforeClear && l.params.onBeforeClear(l, l.fragment), l.ul[0].innerHTML = "", l.params.onItemsBeforeInsert && l.params.onItemsBeforeInsert(l, l.fragment), i && 0 === i.length ? (l.reachEnd = !0, l.params.emptyTemplate && (l.ul[0].innerHTML = l.params.emptyTemplate)) : l.ul[0].appendChild(l.fragment), l.params.onItemsAfterInsert && l.params.onItemsAfterInsert(l, l.fragment)), void 0 !== a && e && l.pageContent.scrollTop(a, 0), l.params.renderExternal && l.params.renderExternal(l, {
                                fromIndex: r,
                                toIndex: n,
                                listHeight: h,
                                topPosition: w,
                    ...
                    }, l.scrollToItem = function(e) {
                        if (e > l.items.length) return !1;
                        var a, t = 0;
                        if (g)
                            for (var r = 0; r < e; r++) t += l.heights[r];
                        else t = e * l.params.height;
                        return a = l.listBlock[0].offsetTop, l.render(!0, a + t - parseInt(l.pageContent.css("padding-top"), 10)), !0
                    }, l.handleScroll = function(e) {
                        l.render()
                    }, l._isVisible = function(e) {
                        return !!(e.offsetWidth || e.offsetHeight || e.getClientRects().length)
                    }, l.handleResize = function(e) {
                        l._isVisible(l.listBlock[0]) && (l.setListSize(), l.render(!0))
                    }, l.attachEvents = function(e) {
                        var a = e ? "off" : "on";
                        l.pageContent[a]("scroll", l.handleScroll), l.listBlock.parents(".tab").eq(0)[a]("tab:show", l.handleResize), l.listBlock.parents(".panel").eq(0)[a]("panel:open", l.handleResize), l.listBlock.parents(".popup").eq(0)[a]("popup:open", l.handleResize), r["on" === a ? "onResize" : "offResize"](l.handleResize)
                    }, l.init = function() {
                        l.attachEvents(), l.setListSize(), l.render()
                    }, l.appendItems = function(e) {
                        for (var a = 0; a < e.length; a++) l.items.push(e[a]);
                        l.update()
                    }, l.appendItem = function(e) {
                        l.appendItems([e])
                    }, l.replaceAllItems = function(e) {
                        l.items = e, delete l.filteredItems, l.domCache = {}, l.update()
                    }, l.replaceItem = function(e, a) {
                        l.items[e] = a, l.params.cache && delete l.domCache[e], l.update()
                    }, l.prependItems = function(e) {
                        for (var a = e.length - 1; a >= 0; a--) l.items.unshift(e[a]);
                        if (l.params.cache) {
                            var t = {};
                            for (var r in l.domCache) t[parseInt(r, 10) + e.length] = l.domCache[r];
                            l.domCache = t
                        }
                        l.update()
                    }, l.prependItem = function(e) {
                        l.prependItems([e])
                    }, l.moveItem = function(e, a) {
                        if (e !== a) {
                            var t = l.items.splice(e, 1)[0];
                            if (a >= l.items.length ? (l.items.push(t), a = l.items.length - 1) : l.items.splice(a, 0, t), l.params.cache) {
                                var r = {};
                                for (var n in l.domCache) {
                                    var i = parseInt(n, 10),
                                        s = e < a ? e : a,
                                        o = e < a ? a : e,
                                        p = e < a ? -1 : 1;
                                    (i < s || i > o) && (r[i] = l.domCache[i]), i === s && (r[o] = l.domCache[i]), i > s && i <= o && (r[i + p] = l.domCache[i])
                                }
                                l.domCache = r
                            }
                            l.update()
                        }
                    }, l.insertItemBefore = function(e, a) {
                        if (0 !== e)
                            if (e >= l.items.length) l.appendItem(a);
                            else {
                                if (l.items.splice(e, 0, a), l.params.cache) {
                                    var t = {};
                                    for (var r in l.domCache) {
                                        var n = parseInt(r, 10);
                                        n >= e && (t[n + 1] = l.domCache[n])
                                    }
                                    l.domCache = t
                                }
                                l.update()
                            }
                        else l.prependItem(a)
                    }, l.deleteItems = function(e) {
                        for (var a, t = 0, r = 0; r < e.length; r++) {
                            var n = e[r];
                            void 0 !== a && n > a && (t = -r), n += t, a = e[r];
                            var i = l.items.splice(n, 1)[0];
                            if (l.filteredItems && l.filteredItems.indexOf(i) >= 0 && l.filteredItems.splice(l.filteredItems.indexOf(i), 1), l.params.cache) {
                                var s = {};
                                for (var o in l.domCache) {
                                    var p = parseInt(o, 10);
                                    p === n ? delete l.domCache[n] : parseInt(o, 10) > n ? s[p - 1] = l.domCache[o] : s[p] = l.domCache[o]
                                }
                                l.domCache = s
                            }
                        }
                        l.update()
                    }, l.deleteAllItems = function() {
                        l.items = [], delete l.filteredItems, l.params.cache && (l.domCache = {}), l.update()
                    }, l.deleteItem = function(e) {
                        l.deleteItems([e])
                    }, l.clearCache = function() {
                        l.domCache = {}
                    }, l.update = function() {
                        l.setListSize(), l.render(!0)
                    }, l.destroy = function() {
                        l.attachEvents(!0), delete l.items, delete l.domCache
                    }, l.init(), l.listBlock[0].f7VirtualList = l, l
                }(e, a)
            }, r.reinitVirtualList = function(e) {
                var a = i(e).find(".virtual-list");
                if (0 !== a.length)
                    for (var t = 0; t < a.length; t++) {
                        var r = a[t].f7VirtualList;
                        r && r.update()
                    }
                ...
                function a(e) {
                    if (p)
                        ...
                        } else if (d && p && c) return;
                    (u = i(this)).hasClass("refreshing") || (d = !1, w = !1, p = !0, c = void 0, g = void 0, "touchstart" === e.type && (l = e.targetTouches[0].identifier), C.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, C.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, (new Date).getTime())
                }
                ...
                function t(e) {
                    if (p) {
                        ...
                        if ("touchmove" === e.type) {
                            if (l && e.touches)
                                for (var i = 0; i < e.touches.length; i++) e.touches[i].identifier === l && (n = e.touches[i]);
                            n || (n = e.targetTouches[0]), a = n.pageX, t = n.pageY
                        } else a = e.pageX, t = e.pageY;
                        if (a && t) {
                            if (void 0 === c && (c = !!(c || Math.abs(t - C.y) > Math.abs(a - C.x))), !c) return void(p = !1);
                            if (f = u[0].scrollTop, void 0 === g && 0 !== f && (g = !0), !d) {
                                if (u.removeClass("transitioning"), f > u[0].offsetHeight) return void(p = !1);
                                b && ((v = u.attr("data-ptr-distance")).indexOf("%") >= 0 && (v = u[0].offsetHeight * parseInt(v, 10) / 100)), T = u.hasClass("refreshing") ? v : 0, x = u[0].scrollHeight === u[0].offsetHeight || "ios" !== r.device.os
                            }
                            if (d = !0, !((m = t - C.y) > 0 && f <= 0 || f < 0)) return w = !1, u.removeClass("pull-up pull-down"), void(y = !1);
                            "ios" === r.device.os && parseInt(r.device.osVersion.split(".")[0], 10) > 7 && 0 === f && !g && (x = !0), x && (e.preventDefault(), h = Math.pow(m, .85) + T, u.transform("translate3d(0," + h + "px,0)")), x && Math.pow(m, .85) > v || !x && m >= 2 * v ? (y = !0, u.addClass("pull-up").removeClass("pull-down")) : (y = !1, u.removeClass("pull-up").addClass("pull-down")), w || (u.trigger("pullstart ptr:pullstart"), w = !0), u.trigger("pullmove ptr:pullmove", {
                                event: e,
                                scrollTop: f,
                                translate: h,
                                touchesDiff: m
                ...
                function n(e) {
                    return "touchend" === e.type && e.changedTouches && e.changedTouches.length > 0 && l && e.changedTouches[0].identifier !== l ? (p = !1, c = !1, d = !1, void(l = null)) : p && d ? (h && (u.addClass("transitioning"), h = 0), u.transform(""), y ? (u.addClass("refreshing"), u.trigger("refresh ptr:refresh", {
                        done: function() {
                            r.pullToRefreshDone(u)
                        }
                    })) : u.removeClass("pull-down"), p = !1, d = !1, void(w && u.trigger("pullend ptr:pullend"))) : (p = !1, void(d = !1))
                }

                function s(e) {
                    e.off(r.touchEvents.start, a, S), e.off(r.touchEvents.move, t, M), e.off(r.touchEvents.end, n, S)
                }
                var o = i(e);
                if (o.hasClass("pull-to-refresh-content") || (o = o.find(".pull-to-refresh-content")), o && 0 !== o.length) {
                    var l, p, d, c, m, u, h, f, g, v, b, w, C = {},
                        y = !1,
                        x = !1,
                        T = 0,
                        k = o.hasClass("page") ? o : o.parents(".page"),
                        P = !1;
                    (k.find(".navbar").length > 0 || k.parents(".navbar-fixed, .navbar-through").length > 0 || k.hasClass("navbar-fixed") || k.hasClass("navbar-through")) && (P = !0), k.hasClass("no-navbar") && (P = !1), P || o.addClass("pull-to-refresh-no-navbar"), (u = o).attr("data-ptr-distance") ? b = !0 : v = 44;
                    var S = !("touchstart" !== r.touchEvents.start || !r.support.passiveListener) && {
                            passive: !0,
                            capture: !1
                        },
                        M = !!r.support.passiveListener && {
                            passive: !1,
                            capture: !1
                        };
                    if (o.on(r.touchEvents.start, a, S), o.on(r.touchEvents.move, t, M), o.on(r.touchEvents.end, n, S), 0 !== k.length) {
                        for (var I = 0; I < o.length; I++) o[I].f7DestroyPullToRefresh = s;
                        k.on("page:beforeremove", function e() {
                            s(o), k.off("page:beforeremove", e)
                        })
                    }
                }
            }, r.pullToRefreshDone = function(e) {
                0 === (e = i(e)).length && (e = i(".pull-to-refresh-content.refreshing")), e.removeClass("refreshing").addClass("transitioning"), e.transitionEnd(function() {
                    e.removeClass("transitioning pull-up pull-down"), e.trigger("refreshdone ptr:done")
                })
            }, r.pullToRefreshTrigger = function(e) {
                0 === (e = i(e)).length && (e = i(".pull-to-refresh-content")), e.hasClass("refreshing") || (e.addClass("transitioning refreshing"), e.trigger("refresh ptr:refresh", {
                    done: function() {
                        r.pullToRefreshDone(e)
                    }
                }))
            }, r.destroyPullToRefresh = function(e) {
                var a = (e = i(e)).hasClass("pull-to-refresh-content") ? e : e.find(".pull-to-refresh-content");
                ...
                var a = (e = i(e)).find(".infinite-scroll");
                0 !== a.length && (r.attachInfiniteScroll(a), e.on("page:beforeremove", function t() {
                    r.detachInfiniteScroll(a), e.off("page:beforeremove", t)
                }))
                    ...
                    if (n || s || o) {
                        ...
                        if (0 !== l.length) {
                            var p, d = l.find(".navbar"),
                                c = l.find(".toolbar");
                            o && (0 === (p = l.find(".tabbar")).length && (p = l.parents("." + r.params.viewsClass).find(".tabbar")));
                            var m, u, h = d.length > 0,
                                f = c.length > 0,
                                g = p && p.length > 0;
                            m = u = t[0].scrollTop;
                            var v, b, w, C, y, x, T, k = f && s ? c[0].offsetHeight : 0,
                                P = (g && o ? p[0].offsetHeight : 0) || k;
                            t.on("scroll", a), t[0].f7ScrollToolbarsHandler = a
                        }
                    }
                }
            }, r.destroyScrollToolbars = function(e) {
                var a = (e = i(e)).find(".page-content");
                0 !== a.length && a[0].f7ScrollToolbarsHandler && a.off("scroll", a[0].f7ScrollToolbarsHandler)
            }, r.materialTabbarSetHighlight = function(e, a) {
                i(e).each(function() {
                    var e, t, n = i(this);
                    (a = a || n.find(".tab-link.active")) && a.length > 0 && (n.hasClass("tabbar-scrollable") ? (e = a[0].offsetWidth + "px", t = a[0].offsetLeft + "px") : (e = 1 / n.find(".tab-link").length * 100 + "%", t = 100 * (r.rtl ? -a.index() : a.index()) + "%"), n.find(".tab-link-highlight").css({
                        width: e
                ...
                c && ((d = o.parent()[0].swiper).activeIndex !== s.index() && d.slideTo(s.index(), t ? void 0 : 0, !1));
                var m, u = o.children(".tab.active").removeClass("active").trigger("hide tab:hide");
                (s.addClass("active"), s.trigger("show tab:show"), !l && !c && s.find(".navbar").length > 0) && (m = s.hasClass(r.params.viewClass) ? s[0] : s.parents("." + r.params.viewClass)[0], r.sizeNavbars(m));
                if (a ? a = i(a) : (!(a = i("string" == typeof e ? '.tab-link[href="' + e + '"]' : '.tab-link[href="#' + s.attr("id") + '"]')) || a && 0 === a.length) && i("[data-tab]").each(function() {
                    ...
                    if (u && u.length > 0) {
                        ...
                        f && (h = i('.tab-link[href="#' + f + '"]')), (!h || h && 0 === h.length) && i("[data-tab]").each(function() {
                            u.is(i(this).attr("data-tab")) && (h = i(this))
                        })
                    }
                ...
                0 !== (e = i(e)).length && (e.hasClass("accordion-item-expanded") ? r.accordionClose(e) : r.accordionOpen(e))
            }, r.accordionOpen = function(e) {
                var a = (e = i(e)).parents(".accordion-list").eq(0),
                ...
                var a = (e = i(e)).children(".accordion-item-content");
                ...
                function t() {
                    x && x.addClass("active-state")
                }

                function n(e) {
                    x && (x.removeClass("active-state"), x = null)
                }
                ...
                function s(e, a, t) {
                    if (t) {
                        var r = t[0].getBoundingClientRect(),
                            ...
                            o = r.height,
                            l = r.width,
                            p = Math.max(Math.pow(Math.pow(o, 2) + Math.pow(l, 2), .5), 48);
                        S = i('<div class="ripple-wave" style="width: ' + p + "px; height: " + p + "px; margin-top:-" + p / 2 + "px; margin-left:-" + p / 2 + "px; left:" + n + "px; top:" + s + 'px;"></div>'), t.prepend(S), S[0].clientLeft, I = "translate3d(" + (l / 2 - n) + "px, " + (o / 2 - s) + "px, 0) scale(1)", S.transform(I)
                    }
                }
                ...
                function o() {
                    if (S) {
                        ...
                        S.addClass("ripple-wave-fill").transform(I.replace("scale(1)", "scale(1.01)")).transitionEnd(function() {
                            clearTimeout(a);
                            var e = i(this).addClass("ripple-wave-out").transform(I.replace("scale(1)", "scale(1.01)"));
                            a = setTimeout(function() {
                                e.remove()
                ...
                function l(e, t, n) {
                    (M = function(e) {
                        ...
                        return !1
                    }(e)) && 0 !== M.length ? a(M) ? E = setTimeout(function() {
                        s(c, m, M)
                    }, 80) : s(c, m, M) : M = void 0
                }
                ...
                function d() {
                    S ? o() : M && !w ? (clearTimeout(E), s(c, m, M), setTimeout(o, 0)) : o()
                }
                var c, m, u, h, f, g, v, b, w, C, y, x, T, k, P, S, M, I, E;
                r.params.activeState && i("html").addClass("watch-active-state"), r.device.ios && r.device.webView && window.addEventListener("touchstart", function() {}), r.support.touch ? (document.addEventListener("click", function(e) {
                    var a, t, n, s, o = !1;
                    return f ? (h = null, f = !1, !0) : "submit" === e.target.type && 0 === e.detail || "file" === e.target.type || (h || (n = e.target, s = "input select textarea label".split(" "), !!(n.nodeName && s.indexOf(n.nodeName.toLowerCase()) >= 0)) || (o = !0), k || (o = !0), document.activeElement === h && (o = !0), e.forwardedTouchEvent && (o = !0), e.cancelable || (o = !0), r.params.tapHold && r.params.tapHoldPreventClicks && C && (o = !1), o || (e.stopImmediatePropagation(), e.stopPropagation(), h ? (t = !0, ((a = i(a = h)).is("label") || a.parents("label").length > 0) && (t = !r.device.android && !(!r.device.ios || !a.is("input"))), (t || w) && e.preventDefault()) : e.preventDefault(), h = null), P = setTimeout(function() {
                        k = !1
                    }, r.device.ios || r.device.androidChrome ? 100 : 400), r.params.tapHold && (y = setTimeout(function() {
                        C = !1
                    }, r.device.ios || r.device.androidChrome ? 100 : 400)), o)
                }, !0), document.addEventListener("touchstart", function(s) {
                    if (w = !1, C = !1, s.targetTouches.length > 1) return x && n(), !0;
                    if (s.touches.length > 1 && x && n(), r.params.tapHold && (y && clearTimeout(y), y = setTimeout(function() {
                            s && s.touches && s.touches.length > 1 || (C = !0, s.preventDefault(), i(s.target).trigger("taphold"))
                        }, r.params.tapHoldDelay)), P && clearTimeout(P), o = s.target, p = i(o), !(k = !("input" === o.nodeName.toLowerCase() && ("file" === o.type || "range" === o.type) || "select" === o.nodeName.toLowerCase() && r.device.android || p.hasClass("no-fastclick") || p.parents(".no-fastclick").length > 0 || r.params.fastClicksExclude && p.is(r.params.fastClicksExclude)))) return f = !1, !0;
                    var o, p, d, S;
                    if (r.device.ios || r.device.android && "getSelection" in window) {
                        var M = window.getSelection();
                        if (M.rangeCount && M.focusNode !== document.body && (!M.isCollapsed || document.activeElement === M.focusNode)) return g = !0, !0;
                        g = !1
                    }
                    r.device.android && (d = s.target, S = "button input textarea select".split(" "), !(!document.activeElement || d === document.activeElement || document.activeElement === document.body || S.indexOf(d.nodeName.toLowerCase()) >= 0)) && document.activeElement.blur(), f = !0, h = s.target, u = (new Date).getTime(), c = s.targetTouches[0].pageX, m = s.targetTouches[0].pageY, r.device.ios && (v = void 0, i(h).parents().each(function() {
                        this.scrollHeight > this.offsetHeight && !v && ((v = this).f7ScrollTop = v.scrollTop)
                    })), s.timeStamp - b < r.params.fastClicksDelayBetweenClicks && s.preventDefault(), r.params.activeState && (a(x = e(h)) ? T = setTimeout(t, 80) : t()), r.params.material && r.params.materialRipple && l(h)
                    ...
                    if (f) {
                        ...
                        if (t) {
                            ...
                            (Math.abs(i - c) > t || Math.abs(s - m) > t) && (a = !0)
                        } else a = !0;
                        a && (f = !1, h = null, w = !0, r.params.tapHold && clearTimeout(y), r.params.activeState && (clearTimeout(T), n()), r.params.material && r.params.materialRipple && p())
                    }
                }), document.addEventListener("touchend", function(e) {
                    if (clearTimeout(T), clearTimeout(y), !f) return !g && k && (r.device.android && !e.cancelable || e.preventDefault()), !0;
                    if (document.activeElement === e.target) return r.params.activeState && n(), r.params.material && r.params.materialRipple && d(), !0;
                    if (g || e.preventDefault(), e.timeStamp - b < r.params.fastClicksDelayBetweenClicks) return setTimeout(n, 0), !0;
                    if (b = e.timeStamp, f = !1, r.device.ios && v && v.scrollTop !== v.f7ScrollTop) return !1;
                    if (r.params.activeState && (t(), setTimeout(n, 0)), r.params.material && r.params.materialRipple && d(), function(e) {
                        ...
                        if (r.device.ios && r.device.webView) return event.timeStamp - u > 159 ? (h = null, !1) : (h.focus(), !1);
                        h.focus()
                    }
                    return document.activeElement && h !== document.activeElement && document.activeElement !== document.body && "label" !== h.nodeName.toLowerCase() && document.activeElement.blur(), e.preventDefault(), i = (a = e).changedTouches[0], s = document.createEvent("MouseEvents"), o = "click", r.device.android && "select" === h.nodeName.toLowerCase() && (o = "mousedown"), s.initMouseEvent(o, !0, !0, window, 1, i.screenX, i.screenY, i.clientX, i.clientY, !1, !1, !1, !1, 0, null), s.forwardedTouchEvent = !0, r.device.ios && navigator.standalone ? setTimeout(function() {
                        (h = document.elementFromPoint(a.changedTouches[0].clientX, a.changedTouches[0].clientY)).dispatchEvent(s)
                    }, 10) : h.dispatchEvent(s), !1;
                    var a, i, s, o
                }), document.addEventListener("touchcancel", function(e) {
                    f = !1, h = null, clearTimeout(T), clearTimeout(y), r.params.activeState && n(), r.params.material && r.params.materialRipple && d()
                })) : r.params.activeState && (document.addEventListener("mousedown", function(a) {
                    e(a.target).addClass("active-state"), "which" in a && 3 === a.which && setTimeout(function() {
                        i(".active-state").removeClass("active-state")
                    }, 0), r.params.material && r.params.materialRipple && (c = a.pageX, m = a.pageY, l(a.target, a.pageX, a.pageY))
                }), document.addEventListener("mousemove", function(e) {
                    i(".active-state").removeClass("active-state"), r.params.material && r.params.materialRipple && p()
                }), document.addEventListener("mouseup", function(e) {
                    i(".active-state").removeClass("active-state"), r.params.material && r.params.materialRipple && d()
                })), r.params.material && r.params.materialRipple && document.addEventListener("contextmenu", function(e) {
                    x && n(), d()
                })
            }, r.initClickEvents = function() {
                if (i(document).on("click", "a, .open-panel, .close-panel, .panel-overlay, .modal-overlay, .popup-overlay, .swipeout-delete, .swipeout-close, .close-popup, .open-popup, .open-popover, .open-login-screen, .close-login-screen .smart-select, .toggle-sortable, .open-sortable, .close-sortable, .accordion-item-toggle, .close-picker, .picker-modal-overlay", function(e) {
                        var a = i(this),
                            t = a.attr("href"),
                            n = "a" === a[0].nodeName.toLowerCase();
                        if (n && (a.is(r.params.externalLinks) || t && t.indexOf("javascript:") >= 0)) t && "_system" === a.attr("target") && (e.preventDefault(), window.open(t, "_system"));
                        else {
                            var l, p, d, c, m, u = a.dataset();
                            if (a.hasClass("smart-select") && r.smartSelectOpen && r.smartSelectOpen(a), a.hasClass("open-panel") && (1 === i(".panel").length ? i(".panel").hasClass("panel-left") ? r.openPanel("left") : r.openPanel("right") : "right" === u.panel ? r.openPanel("right") : r.openPanel("left")), a.hasClass("close-panel") && r.closePanel(), a.hasClass("panel-overlay") && (i(".panel.active").trigger("panel:overlay-click"), r.params.panelsCloseByOutside && r.closePanel()), a.hasClass("open-popover") && (l = u.popover ? u.popover : ".popover", r.popover(l, a)), a.hasClass("close-popover") && r.closeModal(".popover.modal-in"), a.hasClass("open-popup") && (p = u.popup ? u.popup : ".popup", r.popup(p)), a.hasClass("close-popup") && (p = u.popup ? u.popup : ".popup.modal-in", r.closeModal(p)), a.hasClass("open-login-screen") && (d = u.loginScreen ? u.loginScreen : ".login-screen", r.loginScreen(d)), a.hasClass("close-login-screen") && r.closeModal(".login-screen.modal-in"), a.hasClass("modal-overlay") && (i(".modal.modal-in").length > 0 && r.params.modalCloseByOutside && r.closeModal(".modal.modal-in"), i(".actions-modal.modal-in").length > 0 && r.params.actionsCloseByOutside && r.closeModal(".actions-modal.modal-in"), i(".popover.modal-in").length > 0 && r.params.popoverCloseByOutside && r.closeModal(".popover.modal-in")), a.hasClass("popup-overlay") && i(".popup.modal-in").length > 0 && r.params.popupCloseByOutside && r.closeModal(".popup.modal-in"), a.hasClass("picker-modal-overlay") && i(".picker-modal.modal-in").length > 0 && r.closeModal(".picker-modal.modal-in"), a.hasClass("close-picker")) {
                                var h = i(".picker-modal.modal-in");
                                h.length > 0 ? r.closeModal(h) : (h = i(".popover.modal-in .picker-modal")).length > 0 && r.closeModal(h.parents(".popover"))
                            }
                            if (a.hasClass("open-picker") && (c = u.picker ? u.picker : ".picker-modal", r.pickerModal(c, a)), a.hasClass("tab-link") && (m = !0, r.showTab(u.tab || a.attr("href"), a)), a.hasClass("swipeout-close") && r.swipeoutClose(a.parents(".swipeout-opened")), a.hasClass("swipeout-delete"))
                                if (u.confirm) {
                                    var f = u.confirm,
                                        g = u.confirmTitle;
                                    g ? r.confirm(f, g, function() {
                                        ...
                                        u.closeOnCancel && r.swipeoutClose(a.parents(".swipeout"))
                            ...
                            if (a.hasClass("toggle-sortable") && r.sortableToggle(u.sortable), a.hasClass("open-sortable") && r.sortableOpen(u.sortable), a.hasClass("close-sortable") && r.sortableClose(u.sortable), a.hasClass("accordion-item-toggle") || a.hasClass("item-link") && a.parent().hasClass("accordion-item")) {
                            ...
                            if (a.hasClass("floating-button") && a.parent().hasClass("speed-dial") && a.parent().toggleClass("speed-dial-opened"), a.hasClass("close-speed-dial") && i(".speed-dial-opened").removeClass("speed-dial-opened"), (!r.params.ajaxLinks || a.is(r.params.ajaxLinks)) && n && r.params.router) {
                                n && e.preventDefault();
                                var b = t && t.length > 0 && "#" !== t && !m,
                                    w = u.template;
                                if (b || a.hasClass("back") || w) {
                                    var C, y, x;
                                    if (u.view ? C = i(u.view)[0].f7View : (C = a.parents("." + r.params.viewClass)[0] && a.parents("." + r.params.viewClass)[0].f7View) && C.params.linksView && ("string" == typeof C.params.linksView ? C = i(C.params.linksView)[0].f7View : C.params.linksView instanceof o && (C = C.params.linksView)), C || r.mainView && (C = r.mainView), !C) return;
                                    if (w) t = void 0;
                                    else {
                                        if (t && 0 === t.indexOf("#") && "#" !== t) {
                                    ...
                                    void 0 !== u.animatePages ? x = u.animatePages : (a.hasClass("with-animation") && (x = !0), a.hasClass("no-animation") && (x = !1));
                                    var T = {
                                        animatePages: x,
                                        ignoreCache: u.ignoreCache,
                                        force: u.force,
                                        reload: u.reload,
                                        reloadPrevious: u.reloadPrevious,
                                        pageName: y,
                                        pushState: u.pushState,
                                        url: t
                                    };
                                    if (r.params.template7Pages) {
                                        T.contextName = u.contextName;
                                        var k = u.context;
                    ...
                    }), (r.params.scrollTopOnNavbarClick || r.params.scrollTopOnStatusbarClick) && i(document).on("click", ".statusbar-overlay, .navbar .center", function(e) {
                        var a = i(this),
                            t = i(e.target);
                        if (!("a" === a[0].nodeName.toLowerCase() || a.parents("a").length > 0 || "a" === t[0].nodeName.toLowerCase() || t.parents("a").length > 0)) {
                            ...
                            if (r.params.scrollTopOnNavbarClick && a.is(".navbar .center")) {
                                ...
                                0 === (n = s.parents(".page-content")).length && (s.parents(".page").length > 0 && (n = s.parents(".page").find(".page-content")), 0 === n.length && s.nextAll(".pages").length > 0 && (n = s.nextAll(".pages").find(".page:not(.page-on-left):not(.page-on-right):not(.cached)").find(".page-content")))
                            }
                    ...
                    }), r.support.touch && !r.device.android) {
                    var e = !!r.support.passiveListener && {
                        passive: !1,
                        capture: !1
                    };
                    i(document).on(r.params.fastClicks ? "touchstart" : "touchmove", ".panel-overlay, .modal-overlay, .preloader-indicator-overlay, .popup-overlay, .searchbar-overlay", function(e) {
                        e.preventDefault()
                    }, e)
                }
            };
            ...
            r.getSize = function() {
                ...
                for (var a = 0; a < c.length; a++) c[a] === e && c.splice(a, 1)
            }, r.resize = function() {
                ...
                var t = (e = i(e)).find("form.store-data");
                ...
                }), t.on("change submit", a), e.on("page:beforeremove", function r() {
                    t.off("change submit", a), e.off("page:beforeremove", r)
                }))
                ...
                var t;
                if (0 !== (e = i(e)).length) return e[0].f7DestroyResizableTextarea = function() {
                ...
                (e = i(e)).length > 0 && e.is("textarea") && e[0].f7DestroyResizableTextarea ? e[0].f7DestroyResizableTextarea() : e.length > 0 && e.find("textarea.resiable").each(function() {
                    this.f7DestroyResizableTextarea && this.f7DestroyResizableTextarea()
                })
            }, r.initPageResizableTextarea = function(e) {
                (e = i(e)).find("textarea.resizable").each(function() {
                    r.resizableTextarea(this)
                })
            }, r.initPageMaterialInputs = function(e) {
                (e = i(e)).find("textarea.resizable"), e.find(".item-input").each(function() {
                    var e = i(this),
                ...
                var e = ["checkbox", "button", "submit", "range", "radio", "image"];
                i(document).on("change", "input, textarea, select", function(a) {
                    var t = i(this),
                        r = t.val(),
                        n = t.attr("type");
                    if (!(e.indexOf(n) >= 0)) {
                        var s = t.add(t.parents(".item-input, .input-field")).add(t.parents(".item-inner").eq(0));
                        0 !== s.length && (r && "string" == typeof r && "" !== r.trim() || Array.isArray(r) && r.length > 0 ? s.addClass("not-empty-state") : s.removeClass("not-empty-state"))
                    }
                }, !0), i(document).on("focus", "input, textarea, select", function(a) {
                    var t = i(this),
                        r = t.attr("type");
                    e.indexOf(r) >= 0 || t.add(t.parents(".item-input, .input-field")).add(t.parents(".item-inner").eq(0)).removeClass("not-empty-state").addClass("focus-state")
                }, !0), i(document).on("blur", "input, textarea, select", function(a) {
                    var t = i(this),
                        r = t.val(),
                        n = t.attr("type");
                    if (!(e.indexOf(n) >= 0)) {
                        var s = t.add(t.parents(".item-input, .input-field")).add(t.parents(".item-inner").eq(0));
                        s.removeClass("focus-state"), r && "" !== r.trim() ? s.removeClass("focus-state").addClass("not-empty-state") : s.removeClass("not-empty-state")
                    }
                }, !0)
                ...
                }), document.readyState && "complete" === document.readyState && (e = !1), i(window).on("popstate", function(a) {
                    if (!e) {
                        var t = r.mainView;
                        if (t) {
                            var n = a.state;
                ...
                var a = (e = i(e)).find(".swiper-init, .tabs-swipeable-wrap");
                0 !== a.length && a.each(function() {
                    ...
                    }), n = r.swiper(s[0], t), e.on("page:beforeremove", function a() {
            ...
            r.photoBrowser = function(e) {
                return new function(e) {
                    ...
                    !(e = e || {}).backLinkText && r.params.material && (t.backLinkText = "");
                    ...
                    return a.swipeCloseTouchStart = function(e, a) {
                        ...
                        if (w = !1, y) {
                            ...
                            i < 300 && n > 20 || i >= 300 && n > 100 ? setTimeout(function() {
                ...
                return new function(e) {
                    function a(e) {
                        ...
                        o.params.source && o.params.source(o, a, function(e) {
                            var t, r, n = "",
                                i = o.params.limit ? Math.min(o.params.limit, e.length) : e.length;
                            for (o.items = e, o.params.highlightMatches && (a = a.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), r = new RegExp("(" + a + ")", "i")), t = 0; t < i; t++) {
                                var s = "object" == typeof e[t] ? e[t][o.params.valueProperty] : e[t],
                                    l = "object" != typeof e[t] ? e[t] : e[t][o.params.textProperty];
                                n += o.dropdownItemTemplate({
                                    value: s,
                                    text: o.params.highlightMatches ? l.replace(r, "<b>$1</b>") : l
                                })
                            }
                            "" === n && "" === a && o.params.dropdownPlaceholderText && (n += o.dropdownPlaceholderTemplate({
                                text: o.params.dropdownPlaceholderText
                            })), o.dropdown.find("ul").html(n)
                        })
                    }
                    ...
                    if (!o.params.view && o.opener && o.opener.length) {
                        if (0 === (d = o.opener.parents("." + r.params.viewClass)).length) return;
                        d = d[0].f7View
                    }
                    if (!o.params.input || (o.input = i(o.params.input), 0 !== o.input.length || "dropdown" !== o.params.openIn)) {
                        ...
                        return o.popup = void 0, o.dropdown = void 0, o.positionDropDown = function() {
                            ...
                            function a(e) {
                                var a, t;
                                o.params.source && o.params.source(o, e, function(r) {
                                    var n = "",
                            ...
                            o.opened || (o.opened = !0, "dropdown" === o.params.openIn ? (o.dropdown || (o.dropdown = i(o.dropdownTemplate({
                                preloader: o.params.preloader,
                                preloaderColor: o.params.preloaderColor,
                                material: c,
                                materialPreloaderHtml: r.params.materialPreloaderHtml
            ...
            r.picker = function(e) {
                return new function(e) {
                    ...
                    return p.setValue = function(e, a) {
                        ...
                        function n(e) {
                            C || w || (e.preventDefault(), w = !0, y = x = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, T = (new Date).getTime(), L = !0, P = M = i.getTranslate(u.wrapper[0], "y"))
                        }

                        function s(e) {
                            w && (e.preventDefault(), L = !1, x = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, C || (i.cancelAnimationFrame(b), C = !0, P = M = i.getTranslate(u.wrapper[0], "y"), u.wrapper.transition(0)), S = void 0, (M = P + (x - y)) < g && (M = g - Math.pow(g - M, .8), S = "min"), M > v && (M = v + Math.pow(M - v, .8), S = "max"), u.wrapper.transform("translate3d(0," + M + "px,0)"), u.updateItems(void 0, M, 0, p.params.updateValuesOnTouchmove), E = M - I || M, O = (new Date).getTime(), I = M)
                        }

                        function o(e) {
                            if (w && C) {
                                var a;
                                w = C = !1, u.wrapper.transition(""), S && ("min" === S ? u.wrapper.transform("translate3d(0," + g + "px,0)") : u.wrapper.transform("translate3d(0," + v + "px,0)")), (k = (new Date).getTime()) - T > 300 ? a = M : (Math.abs(E / (k - O)), a = M + E * p.params.momentumRatio), a = Math.max(Math.min(a, v), g);
                                var r = -Math.floor((a - v) / h);
                                p.params.freeMode || (a = -r * h + v), u.wrapper.transform("translate3d(0," + parseInt(a, 10) + "px,0)"), u.updateItems(r, a, "", !0), p.params.updateValuesOnMomentum && (t(), u.wrapper.transitionEnd(function() {
                        ...
                        if (!u.divider) {
                            var h, f, g, v, b;
                            u.container = d, u.wrapper = u.container.find(".picker-items-col-wrapper"), u.items = u.wrapper.find(".picker-item"), u.replaceValues = function(e, a) {
                                ...
                                p.params.rotateEffect && (u.container.removeClass("picker-items-col-absolute"), u.width || u.container.css({
                                    width: ""
                                })), e = 0, a = u.container[0].offsetHeight, u.wrapper[0].offsetHeight, h = u.items[0].offsetHeight, f = h * u.items.length, g = a / 2 - f + h / 2, v = a / 2 - h / 2, u.width && (e = u.width, parseInt(e, 10) === e && (e += "px"), u.container.css({
                                    width: e
                            ...
                            }, u.calcSize(), u.wrapper.transform("translate3d(0," + v + "px,0)").transition(0), u.setValue = function(e, a, r) {
                                void 0 === a && (a = "");
                                var n = u.wrapper.find('.picker-item[data-picker-value="' + e + '"]').index();
                                if (void 0 !== n && -1 !== n) {
                                    var s = -n * h + v;
                                    u.wrapper.transition(a), u.wrapper.transform("translate3d(0," + s + "px,0)"), p.params.updateValuesOnMomentum && u.activeIndex && u.activeIndex !== n && (i.cancelAnimationFrame(b), u.wrapper.transitionEnd(function() {
                                        i.cancelAnimationFrame(b)
                                    }), t()), u.updateItems(n, s, a, r)
                                }
                            }, u.updateItems = function(e, a, t, r) {
                                void 0 === a && (a = i.getTranslate(u.wrapper[0], "y")), void 0 === e && (e = -Math.round((a - v) / h)), e < 0 && (e = 0), e >= u.items.length && (e = u.items.length - 1);
                                var n = u.activeIndex;
                                ...
                                p.params.rotateEffect && (Math.floor((a - v) / h), u.items.each(function() {
                                    var e = i(this),
                                        t = (e.index() * h - (v - a)) / h,
                                        r = Math.ceil(u.height / h / 2) + 1,
                                        n = -18 * t;
                                    n > 180 && (n = 180), n < -180 && (n = -180), Math.abs(t) > r ? e.addClass("picker-item-far") : e.removeClass("picker-item-far"), e.transform("translate3d(0, " + (-a + v) + "px, " + (m ? -110 : 0) + "px) rotateX(" + n + "deg)")
                            ...
                            }, a && u.updateItems(0, v, 0);
                            var w, C, y, x, T, k, P, S, M, I, E, O, L = !0;
                        ...
                        "f7DestroyPickerCol" in (e = i(e))[0] && e[0].f7DestroyPickerCol()
                        ...
                        for (e = 0; e < p.params.cols.length; e++) {
                            ...
                            t += p.columnHTML(p.params.cols[e]), p.cols.push(r)
                        }
                        a = '<div class="picker-modal picker-columns ' + (p.params.cssClass || "") + (p.params.rotateEffect ? " picker-3d" : "") + '">' + (p.params.toolbar ? p.params.toolbarTemplate.replace(/{{closeText}}/g, p.params.toolbarCloseText) : "") + '<div class="picker-modal-inner picker-items">' + t + '<div class="picker-center-highlight"></div></div></div>', p.pickerHTML = a
            ...
            r.calendar = function(e) {
                return new function(e) {
                    function a() {
                        var e = !1;
                        return l.params.convertToPopover || l.params.onlyInPopover ? (!l.inline && l.params.input && (l.params.onlyInPopover ? e = !0 : r.device.ios ? e = !!r.device.ipad : r.width >= 768 && (e = !0)), e) : e
                    }

                    function t() {
                        return !!(l.opened && l.container && l.container.length > 0 && l.container.parents(".popover").length > 0)
                    }

                    function n(e) {
                        if (e.preventDefault(), !l.opened && (l.open(), l.params.scrollToInput && !a() && !r.params.material)) {
                            var t = l.input.parents(".page-content");
                            if (0 === t.length) return;
                            var n, i = parseInt(t.css("padding-top"), 10),
                                s = parseInt(t.css("padding-bottom"), 10),
                                o = t[0].offsetHeight - i - l.container.height(),
                                p = t[0].scrollHeight - i - l.container.height(),
                                d = l.input.offset().top - i + l.input[0].offsetHeight;
                            if (d > o) {
                                var c = t.scrollTop() + d - o;
                                c + o > p && (n = c + o - p + s, o === p && (n = l.container.height()), t.css({
                                    "padding-bottom": n + "px"
                                })), t.scrollTop(c, 300)
                            }
                        }
                    ...
                    function s(e) {
                        t() || (l.input && l.input.length > 0 ? e.target !== l.input[0] && 0 === i(e.target).parents(".picker-modal").length && l.close() : 0 === i(e.target).parents(".picker-modal").length && l.close())
                    }

                    function o() {
                        l.opened = !1, l.input && l.input.length > 0 && (l.input.parents(".page-content").css({
                            "padding-bottom": ""
                        }), r.params.material && l.input.trigger("blur")), l.params.onClose && l.params.onClose(l), l.destroyCalendarEvents()
                    }
                    var l = this,
                        p = {
                    ...
                    e = e || {};
                    for (var d in p) void 0 === e[d] && (e[d] = p[d]);
                    l.params = e, l.initialized = !1, l.inline = !!l.params.container, l.isH = "horizontal" === l.params.direction;
                    var c = l.isH && r.rtl ? -1 : 1;
                    return l.animating = !1, l.addValue = function(e) {
                        if (l.params.multiple) {
                            l.value || (l.value = []);
                            for (var a, t = 0; t < l.value.length; t++) new Date(e).getTime() === new Date(l.value[t]).getTime() && (a = t);
                            void 0 === a ? l.value.push(e) : l.value.splice(a, 1), l.updateValue()
                        } else l.params.rangePicker ? (l.value || (l.value = []), 2 !== l.value.length && 0 !== l.value.length || (l.value = []), l.value[0] !== e ? l.value.push(e) : l.value = [], l.value.sort(function(e, a) {
                            return e - a
                        }), l.updateValue()) : (l.value = [e], l.updateValue())
                    }, l.setValue = function(e) {
                        l.value = e, l.updateValue()
                    }, l.updateValue = function(e) {
                        var a, t, n, s, o, p, d, c, m;
                        if (l.container && l.container.length > 0)
                            if (l.wrapper.find(".picker-calendar-day-selected").removeClass("picker-calendar-day-selected"), l.params.rangePicker && 2 === l.value.length)
                                for (a = new Date(l.value[0]).getTime(); a <= new Date(l.value[1]).getTime(); a += 864e5) n = new Date(a), l.wrapper.find('.picker-calendar-day[data-date="' + n.getFullYear() + "-" + n.getMonth() + "-" + n.getDate() + '"]').addClass("picker-calendar-day-selected");
                            else
                                for (a = 0; a < l.value.length; a++) n = new Date(l.value[a]), l.wrapper.find('.picker-calendar-day[data-date="' + n.getFullYear() + "-" + n.getMonth() + "-" + n.getDate() + '"]').addClass("picker-calendar-day-selected");
                        if (l.params.onChange && l.params.onChange(l, l.value), l.input && l.input.length > 0 || r.params.material && l.params.header) {
                            if (l.params.formatValue) t = l.params.formatValue(l, l.value);
                            else {
                                for (t = [], a = 0; a < l.value.length; a++) t.push((s = l.value[a], o = (s = new Date(s)).getFullYear(), p = s.getMonth(), d = p + 1, c = s.getDate(), m = s.getDay(), l.params.dateFormat.replace(/yyyy/g, o).replace(/yy/g, (o + "").substring(2)).replace(/mm/g, d < 10 ? "0" + d : d).replace(/m(\W+)/g, d + "$1").replace(/MM/g, l.params.monthNames[p]).replace(/M(\W+)/g, l.params.monthNamesShort[p] + "$1").replace(/dd/g, c < 10 ? "0" + c : c).replace(/d(\W+)/g, c + "$1").replace(/DD/g, l.params.dayNames[m]).replace(/D(\W+)/g, l.params.dayNamesShort[m] + "$1")));
                                t = t.join(l.params.rangePicker ? " - " : ", ")
                            }
                            r.params.material && l.params.header && l.container && l.container.length > 0 && l.container.find(".picker-calendar-selected-date").text(t), l.input && l.input.length > 0 && !e && (i(l.input).val(t), i(l.input).trigger("change"))
                        }
                    }, l.initCalendarEvents = function() {
                        function e(e) {
                            o || s || (s = !0, p = u = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, d = u = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, h = (new Date).getTime(), b = 0, y = !0, C = void 0, f = l.monthsTranslate)
                        }

                        function a(e) {
                            if (s) {
                                if (m = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, u = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, void 0 === C && (C = !!(C || Math.abs(u - d) > Math.abs(m - p))), l.isH && C) return void(s = !1);
                                if (e.preventDefault(), l.animating) return void(s = !1);
                                y = !1, o || (o = !0, g = l.wrapper[0].offsetWidth, v = l.wrapper[0].offsetHeight, l.wrapper.transition(0)), w = l.isH ? m - p : u - d, b = w / (l.isH ? g : v), f = 100 * (l.monthsTranslate * c + b), l.wrapper.transform("translate3d(" + (l.isH ? f : 0) + "%, " + (l.isH ? 0 : f) + "%, 0)")
                            }
                        }

                        function t(e) {
                            s && o ? (s = o = !1, (new Date).getTime() - h < 300 ? Math.abs(w) < 10 ? l.resetMonth() : w >= 10 ? r.rtl ? l.nextMonth() : l.prevMonth() : r.rtl ? l.prevMonth() : l.nextMonth() : b <= -.5 ? r.rtl ? l.prevMonth() : l.nextMonth() : b >= .5 ? r.rtl ? l.nextMonth() : l.prevMonth() : l.resetMonth(), setTimeout(function() {
                                y = !0
                            }, 100)) : s = o = !1
                        }
                        ...
                        function n(e) {
                            if (y) {
                                ...
                                if (0 === a.length && i(e.target).hasClass("picker-calendar-day") && (a = i(e.target)), 0 !== a.length && !a.hasClass("picker-calendar-day-disabled")) {
                                    l.params.rangePicker || (a.hasClass("picker-calendar-day-next") && l.nextMonth(), a.hasClass("picker-calendar-day-prev") && l.prevMonth());
                                    var t = a.attr("data-year"),
                                        r = a.attr("data-month"),
                                        n = a.attr("data-day");
                                    l.params.onDayClick && l.params.onDayClick(l, a[0], t, r, n), (!a.hasClass("picker-calendar-day-selected") || l.params.multiple || l.params.rangePicker) && l.addValue(new Date(t, r, n, 0, 0, 0)), l.params.closeOnSelect && (l.params.rangePicker && 2 === l.value.length || !l.params.rangePicker) && l.close()
                                }
                            }
                        }
                        var s, o, p, d, m, u, h, f, g, v, b, w, C, y = !0;
                        l.container.find(".picker-calendar-prev-month").on("click", l.prevMonth), l.container.find(".picker-calendar-next-month").on("click", l.nextMonth), l.container.find(".picker-calendar-prev-year").on("click", l.prevYear), l.container.find(".picker-calendar-next-year").on("click", l.nextYear), l.wrapper.on("click", n);
                        var x = !("touchstart" !== r.touchEvents.start || !r.support.passiveListener) && {
                                passive: !0,
                                capture: !1
                            },
                            T = !!r.support.passiveListener && {
                        ...
                        l.params.touchMove && (l.wrapper.on(r.touchEvents.start, e, x), l.wrapper.on(r.touchEvents.move, a, T), l.wrapper.on(r.touchEvents.end, t, x)), l.container[0].f7DestroyCalendarEvents = function() {
                            l.container.find(".picker-calendar-prev-month").off("click", l.prevMonth), l.container.find(".picker-calendar-next-month").off("click", l.nextMonth), l.container.find(".picker-calendar-prev-year").off("click", l.prevYear), l.container.find(".picker-calendar-next-year").off("click", l.nextYear), l.wrapper.off("click", n), l.params.touchMove && (l.wrapper.off(r.touchEvents.start, e, x), l.wrapper.off(r.touchEvents.move, a, T), l.wrapper.off(r.touchEvents.end, t, x))
                        }
                    }, l.destroyCalendarEvents = function(e) {
                        "f7DestroyCalendarEvents" in l.container[0] && l.container[0].f7DestroyCalendarEvents()
                    }, l.dateInRange = function(e, a) {
                        var t, r = !1;
                        if (!a) return !1;
                        if (Array.isArray(a))
                        ...
                        var n = l.daysInMonth(new Date(e.getFullYear(), e.getMonth()).getTime() - 864e6),
                            i = l.daysInMonth(e),
                            s = new Date(e.getFullYear(), e.getMonth()).getDay();
                        0 === s && (s = 7);
                        var o, p, d, c, m, u, h = [],
                            f = "",
                            g = l.params.firstDay - 1 + 0,
                            v = (new Date).setHours(0, 0, 0, 0),
                            b = l.params.minDate ? new Date(l.params.minDate).getTime() : null,
                            w = l.params.maxDate ? new Date(l.params.maxDate).getTime() : null;
                        if (l.value && l.value.length)
                            for (p = 0; p < l.value.length; p++) h.push(new Date(l.value[p]).setHours(0, 0, 0, 0));
                        for (p = 1; p <= 6; p++) {
                            var C = "";
                            for (d = 1; d <= 7; d++) {
                                var y = d,
                                    x = ++g - s,
                                    T = y - 1 + l.params.firstDay > 6 ? y - 1 - 7 + l.params.firstDay : y - 1 + l.params.firstDay,
                                    k = "";
                                if (x < 0 ? (x = n + x + 1, k += " picker-calendar-day-prev", o = new Date(r - 1 < 0 ? t - 1 : t, r - 1 < 0 ? 11 : r - 1, x).getTime()) : (x += 1) > i ? (x -= i, k += " picker-calendar-day-next", o = new Date(r + 1 > 11 ? t + 1 : t, r + 1 > 11 ? 0 : r + 1, x).getTime()) : o = new Date(t, r, x).getTime(), o === v && (k += " picker-calendar-day-today"), l.params.rangePicker && 2 === h.length ? o >= h[0] && o <= h[1] && (k += " picker-calendar-day-selected") : h.indexOf(o) >= 0 && (k += " picker-calendar-day-selected"), l.params.weekendDays.indexOf(T) >= 0 && (k += " picker-calendar-day-weekend"), u = !1, l.params.events && l.dateInRange(o, l.params.events) && (u = !0), u && (k += " picker-calendar-day-has-events"), l.params.rangesClasses)
                                    for (c = 0; c < l.params.rangesClasses.length; c++) l.dateInRange(o, l.params.rangesClasses[c].range) && (k += " " + l.params.rangesClasses[c].cssClass);
                                m = !1, (b && o < b || w && o > w) && (m = !0), l.params.disabled && l.dateInRange(o, l.params.disabled) && (m = !0), m && (k += " picker-calendar-day-disabled");
                                var P = (o = new Date(o)).getFullYear(),
                                    S = o.getMonth();
                        ...
                        return '<div class="picker-calendar-month" data-year="' + t + '" data-month="' + r + '">' + f + "</div>"
                    }, l.animating = !1, l.updateCurrentMonthYear = function(e) {
                        void 0 === e ? (l.currentMonth = parseInt(l.months.eq(1).attr("data-month"), 10), l.currentYear = parseInt(l.months.eq(1).attr("data-year"), 10)) : (l.currentMonth = parseInt(l.months.eq("next" === e ? l.months.length - 1 : 0).attr("data-month"), 10), l.currentYear = parseInt(l.months.eq("next" === e ? l.months.length - 1 : 0).attr("data-year"), 10)), l.container.find(".current-month-value").text(l.params.monthNames[l.currentMonth]), l.container.find(".current-year-value").text(l.currentYear)
                    }, l.onMonthChangeStart = function(e) {
                        l.updateCurrentMonthYear(e), l.months.removeClass("picker-calendar-month-current picker-calendar-month-prev picker-calendar-month-next");
                        var a = "next" === e ? l.months.length - 1 : 0;
                        l.months.eq(a).addClass("picker-calendar-month-current"), l.months.eq("next" === e ? a - 1 : a + 1).addClass("next" === e ? "picker-calendar-month-prev" : "picker-calendar-month-next"), l.params.onMonthYearChangeStart && l.params.onMonthYearChangeStart(l, l.currentYear, l.currentMonth)
                    }, l.onMonthChangeEnd = function(e, a) {
                        var t, r, n;
                        l.animating = !1, l.wrapper.find(".picker-calendar-month:not(.picker-calendar-month-prev):not(.picker-calendar-month-current):not(.picker-calendar-month-next)").remove(), void 0 === e && (e = "next", a = !0), a ? (l.wrapper.find(".picker-calendar-month-next, .picker-calendar-month-prev").remove(), r = l.monthHTML(new Date(l.currentYear, l.currentMonth), "prev"), t = l.monthHTML(new Date(l.currentYear, l.currentMonth), "next")) : n = l.monthHTML(new Date(l.currentYear, l.currentMonth), e), ("next" === e || a) && l.wrapper.append(n || t), ("prev" === e || a) && l.wrapper.prepend(n || r), l.months = l.wrapper.find(".picker-calendar-month"), l.setMonthsTranslate(l.monthsTranslate), l.params.onMonthAdd && l.params.onMonthAdd(l, "next" === e ? l.months.eq(l.months.length - 1)[0] : l.months.eq(0)[0]), l.params.onMonthYearChangeEnd && l.params.onMonthYearChangeEnd(l, l.currentYear, l.currentMonth)
                    }, l.setMonthsTranslate = function(e) {
                        e = e || l.monthsTranslate || 0, void 0 === l.monthsTranslate && (l.monthsTranslate = e), l.months.removeClass("picker-calendar-month-current picker-calendar-month-prev picker-calendar-month-next");
                        var a = 100 * -(e + 1) * c,
                            t = 100 * -e * c,
                            r = 100 * -(e - 1) * c;
                        l.months.eq(0).transform("translate3d(" + (l.isH ? a : 0) + "%, " + (l.isH ? 0 : a) + "%, 0)").addClass("picker-calendar-month-prev"), l.months.eq(1).transform("translate3d(" + (l.isH ? t : 0) + "%, " + (l.isH ? 0 : t) + "%, 0)").addClass("picker-calendar-month-current"), l.months.eq(2).transform("translate3d(" + (l.isH ? r : 0) + "%, " + (l.isH ? 0 : r) + "%, 0)").addClass("picker-calendar-month-next")
                    }, l.nextMonth = function(e) {
                        void 0 !== e && "object" != typeof e || (e = "", l.params.animate || (e = 0));
                        var a = parseInt(l.months.eq(l.months.length - 1).attr("data-month"), 10),
                            t = parseInt(l.months.eq(l.months.length - 1).attr("data-year"), 10),
                            r = new Date(t, a).getTime(),
                            n = !l.animating;
                        if (l.params.maxDate && r > new Date(l.params.maxDate).getTime()) return l.resetMonth();
                        if (l.monthsTranslate--, a === l.currentMonth) {
                            var s = 100 * -l.monthsTranslate * c,
                                o = i(l.monthHTML(r, "next")).transform("translate3d(" + (l.isH ? s : 0) + "%, " + (l.isH ? 0 : s) + "%, 0)").addClass("picker-calendar-month-next");
                            l.wrapper.append(o[0]), l.months = l.wrapper.find(".picker-calendar-month"), l.params.onMonthAdd && l.params.onMonthAdd(l, l.months.eq(l.months.length - 1)[0])
                        }
                        l.animating = !0, l.onMonthChangeStart("next");
                        var p = 100 * l.monthsTranslate * c;
                        l.wrapper.transition(e).transform("translate3d(" + (l.isH ? p : 0) + "%, " + (l.isH ? 0 : p) + "%, 0)"), n && l.wrapper.transitionEnd(function() {
                            l.onMonthChangeEnd("next")
                        }), l.params.animate || l.onMonthChangeEnd("next")
                    }, l.prevMonth = function(e) {
                        void 0 !== e && "object" != typeof e || (e = "", l.params.animate || (e = 0));
                        var a = parseInt(l.months.eq(0).attr("data-month"), 10),
                            t = parseInt(l.months.eq(0).attr("data-year"), 10),
                            r = new Date(t, a + 1, -1).getTime(),
                            n = !l.animating;
                        if (l.params.minDate && r < new Date(l.params.minDate).getTime()) return l.resetMonth();
                        if (l.monthsTranslate++, a === l.currentMonth) {
                            var s = 100 * -l.monthsTranslate * c,
                                o = i(l.monthHTML(r, "prev")).transform("translate3d(" + (l.isH ? s : 0) + "%, " + (l.isH ? 0 : s) + "%, 0)").addClass("picker-calendar-month-prev");
                            l.wrapper.prepend(o[0]), l.months = l.wrapper.find(".picker-calendar-month"), l.params.onMonthAdd && l.params.onMonthAdd(l, l.months.eq(0)[0])
                        }
                        l.animating = !0, l.onMonthChangeStart("prev");
                        var p = 100 * l.monthsTranslate * c;
                        l.wrapper.transition(e).transform("translate3d(" + (l.isH ? p : 0) + "%, " + (l.isH ? 0 : p) + "%, 0)"), n && l.wrapper.transitionEnd(function() {
                            l.onMonthChangeEnd("prev")
                        }), l.params.animate || l.onMonthChangeEnd("prev")
                    }, l.resetMonth = function(e) {
                        void 0 === e && (e = "");
                        var a = 100 * l.monthsTranslate * c;
                        l.wrapper.transition(e).transform("translate3d(" + (l.isH ? a : 0) + "%, " + (l.isH ? 0 : a) + "%, 0)")
                    }, l.setYearMonth = function(e, a, t) {
                        var r;
                        if (void 0 === e && (e = l.currentYear), void 0 === a && (a = l.currentMonth), void 0 !== t && "object" != typeof t || (t = "", l.params.animate || (t = 0)), r = e < l.currentYear ? new Date(e, a + 1, -1).getTime() : new Date(e, a).getTime(), l.params.maxDate && r > new Date(l.params.maxDate).getTime()) return !1;
                        if (l.params.minDate && r < new Date(l.params.minDate).getTime()) return !1;
                        var n = new Date(l.currentYear, l.currentMonth).getTime(),
                            i = r > n ? "next" : "prev",
                            s = l.monthHTML(new Date(e, a));
                        l.monthsTranslate = l.monthsTranslate || 0;
                        var o, p, d = l.monthsTranslate,
                            m = !l.animating;
                        r > n ? (l.monthsTranslate--, l.animating || l.months.eq(l.months.length - 1).remove(), l.wrapper.append(s), l.months = l.wrapper.find(".picker-calendar-month"), o = 100 * -(d - 1) * c, l.months.eq(l.months.length - 1).transform("translate3d(" + (l.isH ? o : 0) + "%, " + (l.isH ? 0 : o) + "%, 0)").addClass("picker-calendar-month-next")) : (l.monthsTranslate++, l.animating || l.months.eq(0).remove(), l.wrapper.prepend(s), l.months = l.wrapper.find(".picker-calendar-month"), o = 100 * -(d + 1) * c, l.months.eq(0).transform("translate3d(" + (l.isH ? o : 0) + "%, " + (l.isH ? 0 : o) + "%, 0)").addClass("picker-calendar-month-prev")), l.params.onMonthAdd && l.params.onMonthAdd(l, "next" === i ? l.months.eq(l.months.length - 1)[0] : l.months.eq(0)[0]), l.animating = !0, l.onMonthChangeStart(i), p = 100 * l.monthsTranslate * c, l.wrapper.transition(t).transform("translate3d(" + (l.isH ? p : 0) + "%, " + (l.isH ? 0 : p) + "%, 0)"), m && l.wrapper.transitionEnd(function() {
                            l.onMonthChangeEnd(i, !0)
                        }), l.params.animate || l.onMonthChangeEnd(i)
                    }, l.nextYear = function() {
                        l.setYearMonth(l.currentYear + 1)
                    }, l.prevYear = function() {
                        l.setYearMonth(l.currentYear - 1)
                    }, l.layout = function() {
                        var e, a, t, r = l.value && l.value.length ? l.value[0] : (new Date).setHours(0, 0, 0, 0),
                            n = '<div class="picker-calendar-months"><div class="picker-calendar-months-wrapper">' + (l.monthHTML(r, "prev") + l.monthHTML(r) + l.monthHTML(r, "next")) + "</div></div>",
                            i = "";
                        if (l.params.weekHeader) {
                            for (e = 0; e < 7; e++) {
                                var s = e + l.params.firstDay > 6 ? e - 7 + l.params.firstDay : e + l.params.firstDay,
                                    o = l.params.dayNamesShort[s];
                                i += '<div class="picker-calendar-week-day ' + (l.params.weekendDays.indexOf(s) >= 0 ? "picker-calendar-week-day-weekend" : "") + '"> ' + o + "</div>"
                            }
                            i = '<div class="picker-calendar-week-days">' + i + "</div>"
                        }
                        t = "picker-modal picker-calendar" + (l.params.rangePicker ? " picker-calendar-range" : "") + (l.params.cssClass ? " " + l.params.cssClass : "");
                        var p = l.params.toolbar ? l.params.toolbarTemplate.replace(/{{closeText}}/g, l.params.toolbarCloseText) : "";
                        l.params.toolbar && (p = l.params.toolbarTemplate.replace(/{{closeText}}/g, l.params.toolbarCloseText).replace(/{{monthPicker}}/g, l.params.monthPicker ? l.params.monthPickerTemplate : "").replace(/{{yearPicker}}/g, l.params.yearPicker ? l.params.yearPickerTemplate : "")), a = '<div class="' + t + '">' + (l.params.header ? l.params.headerTemplate.replace(/{{closeText}}/g, l.params.toolbarCloseText).replace(/{{placeholder}}/g, l.params.headerPlaceholder) : "") + (l.params.footer ? l.params.footerTemplate.replace(/{{closeText}}/g, l.params.toolbarCloseText) : "") + p + '<div class="picker-modal-inner">' + i + n + "</div></div>", l.pickerHTML = a
                    }, l.params.input && (l.input = i(l.params.input), l.input.length > 0 && (l.params.inputReadOnly && l.input.prop("readOnly", !0), l.inline || l.input.on("click", n), l.params.inputReadOnly && l.input.on("focus mousedown", function(e) {
                        e.preventDefault()
                    }))), !l.inline && l.params.closeByOutsideClick && i("html").on("click", s), l.opened = !1, l.open = function() {
                        var e = a(),
                            t = !1;
                        l.opened || (l.value || l.params.value && (l.value = l.params.value, t = !0), l.layout(), e ? (l.pickerHTML = '<div class="popover popover-picker-calendar"><div class="popover-inner">' + l.pickerHTML + "</div></div>", l.popover = r.popover(l.pickerHTML, l.params.input, !0), l.container = i(l.popover).find(".picker-modal"), i(l.popover).on("popover:close", function() {
                            o()
                        })) : l.inline ? (l.container = i(l.pickerHTML), l.container.addClass("picker-modal-inline"), i(l.params.container).append(l.container)) : (l.container = i(r.pickerModal(l.pickerHTML)), i(l.container).on("picker:close", function() {
                            o()
                        })), l.container[0].f7Calendar = l, l.wrapper = l.container.find(".picker-calendar-months-wrapper"), l.months = l.wrapper.find(".picker-calendar-month"), l.updateCurrentMonthYear(), l.monthsTranslate = 0, l.setMonthsTranslate(), l.initCalendarEvents(), t ? l.updateValue() : r.params.material && l.value && l.updateValue(!0), l.input && l.input.length > 0 && r.params.material && l.input.trigger("focus")), l.opened = !0, l.initialized = !0, l.params.onMonthAdd && l.months.each(function() {
                            l.params.onMonthAdd(l, this)
                        }), l.params.onOpen && l.params.onOpen(l)
                    }, l.close = function() {
                        if (l.opened && !l.inline) return t() ? void r.closeModal(l.popover) : void r.closeModal(l.container)
                    }, l.destroy = function() {
                        l.close(), l.params.input && l.input.length > 0 && l.input.off("click focus", n), i("html").off("click", s)
                    }, l.inline ? l.open() : !l.initialized && l.params.value && l.setValue(l.params.value), l
                }(e)
                ...
                if (e) {
                    void 0 === e.media && (e.media = r.params.notificationMedia), void 0 === e.title && (e.title = r.params.notificationTitle), void 0 === e.subtitle && (e.subtitle = r.params.notificationSubtitle), void 0 === e.closeIcon && (e.closeIcon = r.params.notificationCloseIcon), void 0 === e.hold && (e.hold = r.params.notificationHold), void 0 === e.closeOnClick && (e.closeOnClick = r.params.notificationCloseOnClick), void 0 === e.button && (e.button = r.params.notificationCloseButtonText && {
                        ...
                        close: !0
                    }), m || (m = document.createElement("div")), e.material = r.params.material;
                    ...
                    r._compiledTemplates.notification || (r._compiledTemplates.notification = s.compile(n)), m.innerHTML = r._compiledTemplates.notification(e);
                    var o = i(m).children();
                ...
                if (0 !== (e = i(e)).length && !e.hasClass("notification-item-removing")) {
                ...
                var r = (e = i(e)).find(".data-table-header"),
                ...
                var a = (e = i(e)).find(".data-table-init");
            ...
            return r.initPlugins = function() {
                ...
                for (var a = 0; a < u.length; a++) u[a].hooks && e in u[a].hooks && u[a].hooks[e](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
            }, r.pluginPrevent = function(e) {
                for (var a = !1, t = 0; t < u.length; t++) u[t].prevents && e in u[t].prevents && u[t].prevents[e](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]) && (a = !0);
                return a
            }, r.pluginProcess = function(e, a) {
                for (var t = a, r = 0; r < u.length; r++) u[r].preprocess && e in u[r].preprocess && (t = u[r].preprocess[e](a, arguments[2], arguments[3], arguments[4], arguments[5], arguments[6]));
                return t
            }, r.init = function() {
        ...
        }, Framework7.$ = window.Dom7, Framework7.prototype.support = {
            ...
            if (void 0 !== g && "undefined" != typeof Dom7 && (g = Dom7), (void 0 !== g || (g = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (f.$ = g, f.currentBreakpoint = void 0, f.getActiveBreakpoint = function() {
                ...
                f.container[0].swiper = f, f.container.data("swiper", f), f.classNames.push(f.params.containerModifierClass + f.params.direction), f.params.freeMode && f.classNames.push(f.params.containerModifierClass + "free-mode"), f.support.flexbox || (f.classNames.push(f.params.containerModifierClass + "no-flexbox"), f.params.slidesPerColumn = 1), f.params.autoHeight && f.classNames.push(f.params.containerModifierClass + "autoheight"), (f.params.parallax || f.params.watchSlidesVisibility) && (f.params.watchSlidesProgress = !0), f.params.touchReleaseOnEdges && (f.params.resistanceRatio = 0), ["cube", "coverflow", "flip"].indexOf(f.params.effect) >= 0 && (f.support.transforms3d ? (f.params.watchSlidesProgress = !0, f.classNames.push(f.params.containerModifierClass + "3d")) : f.params.effect = "slide"), "slide" !== f.params.effect && f.classNames.push(f.params.containerModifierClass + f.params.effect), "cube" === f.params.effect && (f.params.resistanceRatio = 0, f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.centeredSlides = !1, f.params.spaceBetween = 0, f.params.virtualTranslate = !0), "fade" !== f.params.effect && "flip" !== f.params.effect || (f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.watchSlidesProgress = !0, f.params.spaceBetween = 0, void 0 === p && (f.params.virtualTranslate = !0)), f.params.grabCursor && f.support.touch && (f.params.grabCursor = !1), f.wrapper = f.container.children("." + f.params.wrapperClass), f.params.pagination && (f.paginationContainer = g(f.params.pagination), f.params.uniqueNavElements && "string" == typeof f.params.pagination && f.paginationContainer.length > 1 && 1 === f.container.find(f.params.pagination).length && (f.paginationContainer = f.container.find(f.params.pagination)), "bullets" === f.params.paginationType && f.params.paginationClickable ? f.paginationContainer.addClass(f.params.paginationModifierClass + "clickable") : f.params.paginationClickable = !1, f.paginationContainer.addClass(f.params.paginationModifierClass + f.params.paginationType)), (f.params.nextButton || f.params.prevButton) && (f.params.nextButton && (f.nextButton = g(f.params.nextButton), f.params.uniqueNavElements && "string" == typeof f.params.nextButton && f.nextButton.length > 1 && 1 === f.container.find(f.params.nextButton).length && (f.nextButton = f.container.find(f.params.nextButton))), f.params.prevButton && (f.prevButton = g(f.params.prevButton), f.params.uniqueNavElements && "string" == typeof f.params.prevButton && f.prevButton.length > 1 && 1 === f.container.find(f.params.prevButton).length && (f.prevButton = f.container.find(f.params.prevButton)))), f.isHorizontal = function() {
                    ...
                    var o;
                    e.complete && n ? s() : a ? ((o = new window.Image).onload = s, o.onerror = s, r && (o.sizes = r), t && (o.srcset = t), a && (o.src = a)) : s()
                    ...
                    if (void 0 !== f.size) {
                        ...
                        var o, l, p = f.params.slidesPerColumn,
                            d = s / p,
                            c = d - (f.params.slidesPerColumn * d - f.slides.length);
                        for (e = 0; e < f.slides.length; e++) {
                            o = 0;
                            var m, u, h, g = f.slides.eq(e);
                            if (f.params.slidesPerColumn > 1) "column" === f.params.slidesPerColumnFill ? (h = e - (u = Math.floor(e / p)) * p, (u > c || u === c && h === p - 1) && ++h >= p && (h = 0, u++), m = u + h * s / p, g.css({
                                "-webkit-box-ordinal-group": m,
                                "-moz-box-ordinal-group": m,
                                "-ms-flex-order": m,
                                "-webkit-order": m,
                                order: m
                            })) : u = e - (h = Math.floor(e / d)) * d, g.css("margin-" + (f.isHorizontal() ? "top" : "left"), 0 !== h && f.params.spaceBetween && f.params.spaceBetween + "px").attr("data-swiper-column", u).attr("data-swiper-row", h);
                            "none" !== g.css("display") && ("auto" === f.params.slidesPerView ? (o = f.isHorizontal() ? g.outerWidth(!0) : g.outerHeight(!0), f.params.roundLengths && (o = t(o))) : (o = (f.size - (f.params.slidesPerView - 1) * a) / f.params.slidesPerView, f.params.roundLengths && (o = t(o)), f.isHorizontal() ? f.slides[e].style.width = o + "px" : f.slides[e].style.height = o + "px"), f.slides[e].swiperSlideSize = o, f.slidesSizesGrid.push(o), f.params.centeredSlides ? (r = r + o / 2 + n / 2 + a, 0 === n && 0 !== e && (r = r - f.size / 2 - a), 0 === e && (r = r - f.size / 2 - a), Math.abs(r) < .001 && (r = 0), i % f.params.slidesPerGroup == 0 && f.snapGrid.push(r), f.slidesGrid.push(r)) : (i % f.params.slidesPerGroup == 0 && f.snapGrid.push(r), f.slidesGrid.push(r), r = r + o + a), f.virtualSize += o + a, n = o, i++)
                        }
                        if (f.virtualSize = Math.max(f.virtualSize, f.size) + f.params.slidesOffsetAfter, f.rtl && f.wrongRTL && ("slide" === f.params.effect || "coverflow" === f.params.effect) && f.wrapper.css({
                            ...
                            for (l = [], e = 0; e < f.snapGrid.length; e++) f.snapGrid[e] < f.virtualSize + f.snapGrid[0] && l.push(f.snapGrid[e]);
                            f.snapGrid = l
                        }
                        if (!f.params.centeredSlides) {
                            for (l = [], e = 0; e < f.snapGrid.length; e++) f.snapGrid[e] <= f.virtualSize - f.size && l.push(f.snapGrid[e]);
                            f.snapGrid = l, Math.floor(f.virtualSize - f.size) - Math.floor(f.snapGrid[f.snapGrid.length - 1]) > 1 && f.snapGrid.push(f.virtualSize - f.size)
                        }
                    ...
                    f.params.normalizeSlideIndex && (e < 0 || void 0 === e) && (e = 0), (t = Math.floor(e / f.params.slidesPerGroup)) >= f.snapGrid.length && (t = f.snapGrid.length - 1), e !== f.activeIndex && (f.snapIndex = t, f.previousIndex = f.activeIndex, f.activeIndex = e, f.updateClasses(), f.updateRealIndex())
                    ...
                    f.params.loop && 0 === t.length && (t = f.slides.eq(0)).addClass(f.params.slideNextClass);
                    ...
                    var t;
                    f && (f.updateContainerSize(), f.updateSlidesSize(), f.updateProgress(), f.updatePagination(), f.updateClasses(), f.params.scrollbar && f.scrollbar && f.scrollbar.set(), e ? (f.controller && f.controller.spline && (f.controller.spline = void 0), f.params.freeMode ? (a(), f.params.autoHeight && f.updateAutoHeight()) : (("auto" === f.params.slidesPerView || f.params.slidesPerView > 1) && f.isEnd && !f.params.centeredSlides ? f.slideTo(f.slides.length - 1, 0, !1, !0) : f.slideTo(f.activeIndex, 0, !1, !0)) || a()) : f.params.autoHeight && f.updateAutoHeight())
                ...
                var b, w, C, y, x, T, k, P, S, M, I, E, O = "input, select, textarea, button, video",
                    L = Date.now(),
                    D = [];
                f.animating = !1, f.touches = {
                    ...
                    if (e.originalEvent && (e = e.originalEvent), (I = "touchstart" === e.type) || !("which" in e) || 3 !== e.which) {
                        ...
                        if (!f.params.swipeHandler || n(e, f.params.swipeHandler)) {
                            ...
                            if (!(f.device.ios && f.params.iOSEdgeSwipeDetection && a <= f.params.iOSEdgeSwipeThreshold)) {
                                if (b = !0, w = !1, C = !0, x = void 0, E = void 0, f.touches.startX = a, f.touches.startY = t, y = Date.now(), f.allowClick = !0, f.updateContainerSize(), f.swipeDirection = void 0, f.params.threshold > 0 && (P = !1), "touchstart" !== e.type) {
                                    var r = !0;
                                    g(e.target).is(O) && (r = !1), document.activeElement && g(document.activeElement).is(O) && document.activeElement.blur(), r && e.preventDefault()
                                }
                    ...
                    if (e.originalEvent && (e = e.originalEvent), !I || "mousemove" !== e.type) {
                        ...
                        if (I && f.params.touchReleaseOnEdges && !f.params.loop)
                            if (f.isHorizontal()) {
                        ...
                        if (I && document.activeElement && e.target === document.activeElement && g(e.target).is(O)) return w = !0, void(f.allowClick = !1);
                        if (C && f.emit("onTouchMove", f, e), !(e.targetTouches && e.targetTouches.length > 1)) {
                            var t;
                            if (f.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, f.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, void 0 === x) f.isHorizontal() && f.touches.currentY === f.touches.startY || !f.isHorizontal() && f.touches.currentX === f.touches.startX ? x = !1 : (t = 180 * Math.atan2(Math.abs(f.touches.currentY - f.touches.startY), Math.abs(f.touches.currentX - f.touches.startX)) / Math.PI, x = f.isHorizontal() ? t > f.params.touchAngle : 90 - t > f.params.touchAngle);
                            if (x && f.emit("onTouchMoveOpposite", f, e), void 0 === E && (f.touches.currentX === f.touches.startX && f.touches.currentY === f.touches.startY || (E = !0)), b) {
                                ...
                                if (E) {
                                    ...
                                    f.params.followFinger && ((f.params.freeMode || f.params.watchSlidesProgress) && f.updateActiveIndex(), f.params.freeMode && (0 === D.length && D.push({
                    ...
                    if (e.originalEvent && (e = e.originalEvent), C && f.emit("onTouchEnd", f, e), C = !1, b) {
                        ...
                        var a, t = Date.now(),
                            r = t - y;
                        if (f.allowClick && (f.updateClickedSlide(e), f.emit("onTap", f, e), r < 300 && t - L > 300 && (S && clearTimeout(S), S = setTimeout(function() {
                            ...
                            }, 300)), r < 300 && t - L < 300 && (S && clearTimeout(S), f.emit("onDoubleTap", f, e))), L = Date.now(), setTimeout(function() {
                                f && (f.allowClick = !0)
                            }, 0), !b || !w || !f.swipeDirection || 0 === f.touches.diff || T === k) return void(b = w = !1);
                        if (b = w = !1, a = f.params.followFinger ? f.rtl ? f.translate : -f.translate : -T, f.params.freeMode) {
                            if (a < -f.minTranslate()) return void f.slideTo(f.activeIndex);
                            if (a > -f.maxTranslate()) return void(f.slides.length < f.snapGrid.length ? f.slideTo(f.snapGrid.length - 1) : f.slideTo(f.slides.length - 1));
                            if (f.params.freeModeMomentum) {
                                ...
                                f.velocity = f.velocity * f.params.freeModeMomentumVelocityRatio, D.length = 0;
                            ...
                            return void((!f.params.freeModeMomentum || r >= f.params.longSwipesMs) && (f.updateProgress(), f.updateActiveIndex()))
                        }
                        var x, P = 0,
                            I = f.slidesSizesGrid[0];
                        for (x = 0; x < f.slidesGrid.length; x += f.params.slidesPerGroup) void 0 !== f.slidesGrid[x + f.params.slidesPerGroup] ? a >= f.slidesGrid[x] && a < f.slidesGrid[x + f.params.slidesPerGroup] && (P = x, I = f.slidesGrid[x + f.params.slidesPerGroup] - f.slidesGrid[x]) : a >= f.slidesGrid[x] && (P = x, I = f.slidesGrid[f.slidesGrid.length - 1] - f.slidesGrid[f.slidesGrid.length - 2]);
                        var E = (a - f.slidesGrid[P]) / I;
                        if (r > f.params.longSwipesMs) {
                            if (!f.params.longSwipes) return void f.slideTo(f.activeIndex);
                            "next" === f.swipeDirection && (E >= f.params.longSwipesRatio ? f.slideTo(P + f.params.slidesPerGroup) : f.slideTo(P)), "prev" === f.swipeDirection && (E > 1 - f.params.longSwipesRatio ? f.slideTo(P + f.params.slidesPerGroup) : f.slideTo(P))
                        } else {
                    ...
                    (0 === s ? 0 : (e - f.minTranslate()) / s) !== f.progress && f.updateProgress(e), a && f.updateActiveIndex(), "slide" !== f.params.effect && f.effects[f.params.effect] && f.effects[f.params.effect].setTranslate(f.translate), f.params.parallax && f.parallax && f.parallax.setTranslate(f.translate), f.params.scrollbar && f.scrollbar && f.scrollbar.setTranslate(f.translate), f.params.control && f.controller && f.controller.setTranslate(f.translate, r), f.emit("onSetTranslate", f, f.translate)
                }, f.getTranslate = function(e, a) {
                    var t, r, n, i;
                    return void 0 === a && (a = "x"), f.params.virtualTranslate ? f.rtl ? -f.translate : f.translate : (n = window.getComputedStyle(e, null), window.WebKitCSSMatrix ? ((r = n.transform || n.webkitTransform).split(",").length > 6 && (r = r.split(", ").map(function(e) {
                        return e.replace(",", ".")
                    }).join(", ")), i = new window.WebKitCSSMatrix("none" === r ? "" : r)) : t = (i = n.MozTransform || n.OTransform || n.MsTransform || n.msTransform || n.transform || n.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === a && (r = window.WebKitCSSMatrix ? i.m41 : 16 === t.length ? parseFloat(t[12]) : parseFloat(t[4])), "y" === a && (r = window.WebKitCSSMatrix ? i.m42 : 16 === t.length ? parseFloat(t[13]) : parseFloat(t[5])), f.rtl && r && (r = -r), r || 0)
                    ...
                    fade: {
                        setTranslate: function() {
                            for (var e = 0; e < f.slides.length; e++) {
                                ...
                                f.params.virtualTranslate || (t -= f.translate);
                                var r = 0;
                                f.isHorizontal() || (r = t, t = 0);
                        ...
                        setTranslate: function() {
                            for (var e = 0; e < f.slides.length; e++) {
                                ...
                                var r = -180 * t,
                                    ...
                                    s = 0;
                                if (f.isHorizontal() ? f.rtl && (r = -r) : (s = i, i = 0, n = -r, r = 0), a[0].style.zIndex = -Math.abs(Math.round(t)) + f.slides.length, f.params.flip.slideShadows) {
                                    var o = f.isHorizontal() ? a.find(".swiper-slide-shadow-left") : a.find(".swiper-slide-shadow-top"),
                                        l = f.isHorizontal() ? a.find(".swiper-slide-shadow-right") : a.find(".swiper-slide-shadow-bottom");
                                    0 === o.length && (o = g('<div class="swiper-slide-shadow-' + (f.isHorizontal() ? "left" : "top") + '"></div>'), a.append(o)), 0 === l.length && (l = g('<div class="swiper-slide-shadow-' + (f.isHorizontal() ? "right" : "bottom") + '"></div>'), a.append(l)), o.length && (o[0].style.opacity = Math.max(-t, 0)), l.length && (l[0].style.opacity = Math.max(t, 0))
                                }
                                a.transform("translate3d(" + i + "px, " + s + "px, 0px) rotateX(" + n + "deg) rotateY(" + r + "deg)")
                            }
                        },
                        setTransition: function(e) {
                    ...
                    cube: {
                        setTranslate: function() {
                            var e, a = 0;
                            f.params.cube.shadow && (f.isHorizontal() ? (0 === (e = f.wrapper.find(".swiper-cube-shadow")).length && (e = g('<div class="swiper-cube-shadow"></div>'), f.wrapper.append(e)), e.css({
                                height: f.width + "px"
                            })) : 0 === (e = f.container.find(".swiper-cube-shadow")).length && (e = g('<div class="swiper-cube-shadow"></div>'), f.container.append(e)));
                            for (var t = 0; t < f.slides.length; t++) {
                                var r = f.slides.eq(t),
                                    n = 90 * t,
                                    i = Math.floor(n / 360);
                        ...
                        setTranslate: function() {
                            for (var e = f.translate, a = f.isHorizontal() ? -e + f.width / 2 : -e + f.height / 2, t = f.isHorizontal() ? f.params.coverflow.rotate : -f.params.coverflow.rotate, r = f.params.coverflow.depth, n = 0, i = f.slides.length; n < i; n++) {
                                var s = f.slides.eq(n),
                                    ...
                                    l = (a - s[0].swiperSlideOffset - o / 2) / o * f.params.coverflow.modifier,
                                    p = f.isHorizontal() ? t * l : 0,
                                    d = f.isHorizontal() ? 0 : t * l,
                                    c = -r * Math.abs(l),
                                    m = f.isHorizontal() ? 0 : f.params.coverflow.stretch * l,
                                    u = f.isHorizontal() ? f.params.coverflow.stretch * l : 0;
                                Math.abs(u) < .001 && (u = 0), Math.abs(m) < .001 && (m = 0), Math.abs(c) < .001 && (c = 0), Math.abs(p) < .001 && (p = 0), Math.abs(d) < .001 && (d = 0);
                                var h = "translate3d(" + u + "px," + m + "px," + c + "px)  rotateX(" + d + "deg) rotateY(" + p + "deg)";
                                if (s.transform(h), s[0].style.zIndex = 1 - Math.abs(Math.round(l)), f.params.coverflow.slideShadows) {
                                    ...
                                    0 === v.length && (v = g('<div class="swiper-slide-shadow-' + (f.isHorizontal() ? "left" : "top") + '"></div>'), s.append(v)), 0 === b.length && (b = g('<div class="swiper-slide-shadow-' + (f.isHorizontal() ? "right" : "bottom") + '"></div>'), s.append(b)), v.length && (v[0].style.opacity = l > 0 ? l : 0), b.length && (b[0].style.opacity = -l > 0 ? -l : 0)
                                }
                            }
                    ...
                    setDragPosition: function(e) {
                        var a = f.scrollbar,
                            t = (f.isHorizontal() ? "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX || e.clientX : "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY || e.clientY) - a.track.offset()[f.isHorizontal() ? "left" : "top"] - a.dragSize / 2,
                            r = -f.minTranslate() * a.moveDivider,
                            n = -f.maxTranslate() * a.moveDivider;
                        t < r ? t = r : t > n && (t = n), t = -t / a.moveDivider, f.updateProgress(t), f.setWrapperTranslate(t, !0)
                    },
                    ...
                    setTranslate: function() {
                        if (f.params.scrollbar) {
                            ...
                            e = (a.trackSize - a.dragSize) * f.progress, f.rtl && f.isHorizontal() ? (e = -e) > 0 ? (t = a.dragSize - e, e = 0) : -e + a.dragSize > a.trackSize && (t = a.trackSize + e) : e < 0 ? (t = a.dragSize + e, e = 0) : e + a.dragSize > a.trackSize && (t = a.trackSize - e), f.isHorizontal() ? (f.support.transforms3d ? a.drag.transform("translate3d(" + e + "px, 0, 0)") : a.drag.transform("translateX(" + e + "px)"), a.drag[0].style.width = t + "px") : (f.support.transforms3d ? a.drag.transform("translate3d(0px, " + e + "px, 0)") : a.drag.transform("translateY(" + e + "px)"), a.drag[0].style.height = t + "px"), f.params.scrollbarHide && (clearTimeout(a.timeout), a.track[0].style.opacity = 1, a.timeout = setTimeout(function() {
                    ...
                    LinearSpline: function(e, a) {
                        var t, r, n, i, s, o = function(e, a) {
                            for (r = -1, t = e.length; t - r > 1;) e[n = t + r >> 1] <= a ? r = n : t = n;
                            return t
                        };
                    ...
                    onGestureStart: function(e) {
                        ...
                        a.gesture.slide && a.gesture.slide.length || (a.gesture.slide = g(this), 0 === a.gesture.slide.length && (a.gesture.slide = f.slides.eq(f.activeIndex)), a.gesture.image = a.gesture.slide.find("img, svg, canvas"), a.gesture.imageWrap = a.gesture.image.parent("." + f.params.zoomContainerClass), a.gesture.zoomMax = a.gesture.imageWrap.attr("data-swiper-zoom") || f.params.zoomMax, 0 !== a.gesture.imageWrap.length) ? (a.gesture.image.transition(0), a.isScaling = !0) : a.gesture.image = void 0
                    },
                    ...
                    toggleZoom: function(e, a) {
                        var t, r, n, i, s, o, l, p, d, c, m, u, h, f, v, b, w = e.zoom;
                ...
                return f.callPlugins = function(e) {
                    ...
                    var a;
                    if (f.params[e] && f.params[e](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]), f.emitterEventListeners[e])
            ...
            isSafari: (o = window.navigator.userAgent.toLowerCase(), o.indexOf("safari") >= 0 && o.indexOf("chrome") < 0 && o.indexOf("android") < 0),
            ...
            device: (a = window.navigator.userAgent, t = a.match(/(Android);?[\s\/]+([\d.]+)?/), r = a.match(/(iPad).*OS\s([\d_]+)/), n = a.match(/(iPod)(.*OS\s([\d_]+))?/), i = !r && a.match(/(iPhone\sOS|iOS)\s([\d_]+)/), {
                ios: r || i || n,
                android: t
            }),
            support: {
